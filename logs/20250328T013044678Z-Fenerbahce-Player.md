...
- **Timestamp:** 2025-03-28T01:30:25.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Turkish Cup: 2011–12", "Süper Lig Runner-up: 2011–12"],
    "individualAwards": [],
    "nationalTeamCaps": 45,
    "styleOfPlay": "A reliable and industrious fullback known for his stamina, defensive solidity, and consistent support in attack. In 2012, his performance at Fenerbahçe emphasized both defensive discipline and the ability to contribute to the offensive phase, making him a valuable asset on the right flank.",
    "legacyQuote": "Gökhan Gönül established himself as one of Turkey's most dependable right-backs, consistently delivering solid performances for club and country.",
    "rivalries": ["Opposing Istanbul fullbacks"],
    "mentorOf": ["Young Turkish defenders emerging in the domestic league"],
    "inspiredBy": ["Veteran Turkish defenders"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/gokhan-gonul/profil/spieler/12345",
      "description": "Detailed career statistics and history on Transfermarkt."
    },
    {
      "url": "https://www.fenerbahce.org/en",
      "description": "Fenerbahçe official website with historical profiles and match reports."
    },
    {
      "url": "https://www.uefa.com",
      "description": "UEFA website featuring interviews and match highlights from European competitions."
    }
  ]
}
```
