...
- **Timestamp:** 2025-03-28T15:04:58.000Z
...
```json
{
  ...
  "attributes": {
    ...
    "specialSkill": "DefensiveGeneral"
  },
  "history": {
    "fullName": "Francisco Chicão",
    "knownAs": "Chicão",
    ...
    "honours": ["Copa Libertadores (2012)"],
    "individualAwards": [],
    "nationalTeamCaps": 12,
    "styleOfPlay": "A solid and commanding center back, Chicão is known for his excellent aerial ability, precise positioning, and leadership on the field. His defensive intelligence and timing in challenges have been pivotal in organizing Corinthians' backline during the 2012 season.",
    "legacyQuote": "A rock at the back – his defensive acumen and commanding presence proved crucial in steering Corinthians to continental glory.",
    "rivalries": ["São Paulo", "Santos"],
    "mentorOf": [],
    "inspiredBy": ["Lúcio"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/chicao/profile",
      "description": "Statistical profile and career history of Chicão on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlights from Chicão's 2012 season, showcasing his defensive prowess."
    }
  ]
}
```
