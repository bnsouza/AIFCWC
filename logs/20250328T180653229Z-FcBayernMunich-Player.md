...
- **Timestamp:** 2025-03-28T18:06:34.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Bundesliga: 2007–08", "DFB-Pokal: 2007–08"],
    "individualAwards": ["UEFA Team of the Year 2013"],
    "nationalTeamCaps": 46,
    "styleOfPlay": "A calm, efficient midfielder known for his precise passing, excellent vision, and ability to control the tempo of the game. Kroos combines technical skill with a high football IQ to dictate play from deep positions.",
    "legacyQuote": "A midfield maestro who redefines consistency and precision in every match he plays.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Lothar Matthäus", "Michael Ballack"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/toni-kroos/profil/spieler/55022",
      "description": "Transfermarkt profile for Toni Kroos."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Toni_Kroos",
      "description": "Wikipedia article on Toni Kroos."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlight reel showcasing Toni Kroos' performance in 2013."
    }
  ]
}
```
