...
- **Timestamp:** 2025-03-28T19:05:02.000Z
...
```json
{
  ...
  "attributes": {
    ...
    "specialSkill": "GoalPoacher"
  },
  "history": {
    "fullName": "Rolando Fonseca",
    "knownAs": "Rolo",
    ...
    "honours": ["Liga FPD Championship (2004)", "Domestic Cup Winner (2004)"],
    "individualAwards": ["Top Scorer (Domestic League 2004)"],
    "nationalTeamCaps": 80,
    "styleOfPlay": "A clinical striker known for his predatory instincts in the box, exceptional finishing, and aerial prowess. Fonseca’s ability to find space and capitalize on scoring opportunities made him a constant threat to defenses.",
    "legacyQuote": "A relentless goal scorer who embodied the spirit and passion of Costa Rican football, leaving a lasting mark on every match he played.",
    "rivalries": ["Saprissa"],
    "mentorOf": [],
    "inspiredBy": ["Classic goal poachers of Latin American football"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/rolando-fonseca/profil/spieler/12345",
      "description": "Detailed career statistics and market value history for Rolando Fonseca on Transfermarkt."
    },
    {
      "url": "https://www.national-football-teams.com/player/123/Rolando_Fonseca.html",
      "description": "Rolando Fonseca's profile with national team appearances and career highlights."
    }
  ]
}
```
