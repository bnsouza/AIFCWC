...
- **Timestamp:** 2025-03-28T18:06:15.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Croatian Footballer of the Year Nominee"],
    "nationalTeamCaps": 50,
    "styleOfPlay": "A hardworking and physically dominant striker known for his aerial prowess, intelligent positioning, and relentless pressing. In 2013 at Bayern Munich, Mandžukić showcased his ability to win aerial duels, create space for teammates, and score crucial goals.",
    "legacyQuote": "Never underestimate the heart of a warrior.",
    "rivalries": ["Notable on-field rivalries with opposing center-forwards in the Bundesliga"],
    "mentorOf": [],
    "inspiredBy": ["Davor Šuker"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/mario-mandzukic/profil/spieler/2985",
      "description": "Transfermarkt profile detailing career statistics and transfers for Mandžukić."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/clubs/players/1904955--mario-mandzukic/",
      "description": "UEFA profile highlighting Mandžukić's performances in European competitions."
    }
  ]
}
```
