...
- **Timestamp:** 2025-03-28T15:06:45.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Jorge Henrique dos Santos",
    "knownAs": "Jorge Henrique",
    ...
    "career": [
      ...
      {
        "club": "Other Clubs (Previous Career)",
        "from": 2006,
        "to": 2011,
        "appearances": 110,
        "goals": 18,
    ...
    "honours": ["State Championship Contention", "Strong Domestic League Performances"],
    "individualAwards": [],
    "nationalTeamCaps": 5,
    "styleOfPlay": "A creative attacking midfielder known for his vision and technical prowess. Jorge Henrique excels in unlocking defenses with precise through passes and powerful long-range shots. His ability to control the tempo in midfield makes him a key component in Corinthian tactical setups.",
    "legacyQuote": "A magician in midfield, turning half-chances into goal-scoring opportunities.",
    "rivalries": ["Rival midfield talents in the domestic league"],
    "mentorOf": [],
    "inspiredBy": ["Rivaldo", "Kaká"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jorge-henrique/profil/spieler/12345",
      "description": "Transfermarkt profile with detailed career statistics."
    },
    {
      "url": "https://www.youtube.com/watch?v=example_highlights",
      "description": "Highlights of Jorge Henrique's performances for Corinthians in 2012."
    }
  ]
}
```
