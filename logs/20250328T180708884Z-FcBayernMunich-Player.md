...
- **Timestamp:** 2025-03-28T18:06:53.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 4,
    "styleOfPlay": "A composed and technically gifted centre-back, Badstuber was known for his excellent reading of the game, strong aerial presence, and ability to initiate plays from the back. His playing style combined traditional defensive solidity with a modern, ball-playing approach.",
    "legacyQuote": "Holger Badstuber combined technical skill with robust defending, symbolizing the modern centre-back who can both stop attackers and contribute to the build-up.",
    "rivalries": ["Borussia Dortmund", "Schalke 04"],
    "mentorOf": [],
    "inspiredBy": ["Franz Beckenbauer", "Mats Hummels"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/holger-badstuber/profil/spieler/4181",
      "description": "Holger Badstuber Transfermarkt profile with detailed statistics and career history."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Holger_Badstuber",
      "description": "Wikipedia page for Holger Badstuber covering his career, honours, and biography."
    }
  ]
}
```
