...
- **Timestamp:** 2025-03-27T23:04:23.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 5,
    "styleOfPlay": "A defensively solid left back known for his relentless work rate, stamina, and ability to seamlessly transition from defense to attack. His commitment and tactical awareness made him a key contributor for Pohang Steelers in 2009.",
    "legacyQuote": "Oh Beom-seok will be remembered as a relentless fullback who never shied away from a challenge, embodying the spirit of Pohang Steelers.",
    "rivalries": ["Rivalry with top opposing fullbacks from Ulsan Hyundai and other K-League contenders"],
    "mentorOf": [],
    "inspiredBy": ["Lee Young-pyo"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/oh-beom-seok/profil/spieler/12345",
      "description": "Transfermarkt profile of Oh Beom-seok with detailed career statistics and market value history."
    },
    {
      "url": "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
      "description": "Highlights compilation of Oh Beom-seok's performances for Pohang Steelers in 2009."
    }
  ]
}
```
