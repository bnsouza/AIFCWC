...
- **Timestamp:** 2025-03-28T08:05:54.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 30,
    "styleOfPlay": "A disciplined and versatile midfielder known for his defensive contributions and ability to support the build-up. In 2019, Dier was recognized for his work-rate and tactical awareness, effectively balancing physicality with smart positioning.",
    "legacyQuote": "A reliable presence in midfield, blending physical strength with intelligent play.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Patrick Vieira", "Roy Keane"]
  },
  "links": [
    {
      "url": "https://en.wikipedia.org/wiki/Eric_Dier",
      "description": "Comprehensive Wikipedia article detailing Eric Dier's career and background."
    },
    {
      "url": "https://www.transfermarkt.com/eric-dier/profil/spieler/181588",
      "description": "Statistical profile and career overview on Transfermarkt."
    },
    {
      "url": "https://www.tottenhamhotspur.com/teams/first-team/players/eric-dier/",
      "description": "Official Tottenham Hotspur profile of Eric Dier with career highlights and current form."
    }
  ]
}
```
