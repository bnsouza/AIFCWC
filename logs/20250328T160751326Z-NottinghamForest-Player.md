...
- **Timestamp:** 2025-03-28T16:07:34.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["European Cup 1979", "League Cup 1978"],
    "individualAwards": ["First £1 Million Transfer Milestone"],
    "nationalTeamCaps": 52,
    "styleOfPlay": "Trevor Francis was known for his intelligent movement, exceptional positioning, and clinical finishing ability. In 1979, at Nottingham Forest, his sense of timing and composure in front of goal made him an ever-present threat, perfectly complementing the team's dynamic, counter-attacking style.",
    "legacyQuote": "A trailblazer in modern forward play, Trevor Francis remains an enduring icon for his pioneering transfer and his ability to deliver in crucial moments.",
    "rivalries": ["Notable on-field battles with top defenders of his era"],
    "mentorOf": [],
    "inspiredBy": ["Great British forwards of the past"]
  },
  "links": [
    {
      "url": "https://en.wikipedia.org/wiki/Trevor_Francis",
      "description": "Wikipedia page detailing Trevor Francis's career and legacy."
    },
    {
      "url": "https://www.transfermarkt.com/trevor-francis/profil/spieler/1",
      "description": "Transfermarkt profile with historical statistics and career details."
    }
  ]
}
```
