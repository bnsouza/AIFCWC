...
- **Timestamp:** 2025-03-28T07:04:43.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Al Sadd Player of the Season 2018"],
    "nationalTeamCaps": 25,
    "styleOfPlay": "A composed playmaker with excellent vision and distribution, Abdelkarim Hassan dictates the tempo of the game from midfield while linking defense and attack with precision. His ability to read the game and deliver incisive passes makes him an invaluable asset in controlling matches.",
    "legacyQuote": "A commanding presence in midfield, his creativity and vision set the rhythm of the game.",
    "rivalries": ["Al-Duhail FC"],
    "mentorOf": ["Emerging young midfielders at Al Sadd"],
    "inspiredBy": ["Xavi Hernández", "Andrés Iniesta"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/abdelkarim-hassan/profil/spieler/123456",
      "description": "Detailed career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.fifa.com/worldcup/players/player=abdelkarim-hassan-123456/index.html",
      "description": "FIFA profile highlighting his international performances."
    }
  ]
}
```
