...
```
Provide the following details for the football club named Colo-Colo (Chile - CONMEBOL):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/colocolooficial",
    "tiktok": "https://www.tiktok.com/@colocolooficial"
  },
  "colors": {
    "home": {
