...
- **Timestamp:** 2025-03-28T08:05:33.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["FA Cup Runner-up (2019)", "UEFA Europa League Runner-up (2016)"],
    "individualAwards": [],
    "nationalTeamCaps": 35,
    "styleOfPlay": "A combative and dynamic defensive midfielder known for his tireless work rate, strong tackling, and ability to break up play while also contributing to the buildup with intelligent passing.",
    "legacyQuote": "A tireless engine in midfield, Sissoko has always brought energy and balance to his teams, embodying both defensive solidity and creative support.",
    "rivalries": [
      "Intense on-field duels with top midfielders from rival clubs, notably during high-stakes clashes in the Premier League."
    ],
    "mentorOf": [],
    "inspiredBy": ["Patrick Vieira", "Claude Makélélé"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/moussa-sissoko/profil/spieler/82790",
      "description": "Transfermarkt profile with detailed career stats and transfer history."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Moussa_Sissoko",
      "description": "Wikipedia page for a full overview of his career and achievements."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/clubs/players/101888/",
