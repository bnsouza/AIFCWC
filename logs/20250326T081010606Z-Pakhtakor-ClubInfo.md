...
```
Provide the following details for the football club named Pakhtakor (Uzbekistan - AFC):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  "foundationDate": "1956-04-08",
  "city": "Tashkent",
  "fullName": "Pakhtakor Tashkent FK",
  "shortName": "Pakhtakor",
  "stadium": {
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/pakhtakor_fc",
    "tiktok": "https://www.tiktok.com/@pakhtakor_fc"
  },
  "colors": {
    "home": {
      "bgColor": "rgb(0, 0, 139)",
