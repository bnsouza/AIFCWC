...
- **Timestamp:** 2025-03-27T23:04:49.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Kim Kwang-min",
    "knownAs": "Kim Kwang-min",
    ...
    "individualAwards": [],
    "nationalTeamCaps": 15,
    "styleOfPlay": "A no-nonsense defensive midfielder, Kim Kwang-min excels in breaking up opposition plays with his intelligent interceptions and robust tackling. His reliable ball distribution and disciplined positioning make him a key pivot for the team's transition from defense to attack.",
    "legacyQuote": "A reliable force in midfield, Kim Kwang-min's performance at Pohang Steelers in 2009 remains a testament to his discipline and work ethic.",
    "rivalries": ["Ulsan Hyundai", "FC Seoul"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/kim-kwang-min/profil/spieler/00000",
      "description": "Detailed career statistics and transfer history of Kim Kwang-min on Transfermarkt."
    },
    {
      "url": "https://www.national-football-teams.com/player/00000/Kim_Kwang_min.html",
      "description": "Career profile and match appearances for Kim Kwang-min on National-Football-Teams.com."
    },
    {
      "url": "https://www.youtube.com/watch?v=exampleID",
      "description": "Highlights from Kim Kwang-min's standout performances during the 2009 season with Pohang Steelers."
    }
  ]
}
```
