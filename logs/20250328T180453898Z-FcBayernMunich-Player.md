...
- **Timestamp:** 2025-03-28T18:04:37.000Z
...
```json
{
  ...
  "attributes": {
    ...
    "specialSkill": "TacticalBrain"
  },
  "history": {
    "fullName": "Javier Martínez Aginaga",
    "knownAs": "Javi Martínez",
    ...
    "honours": ["DFB-Pokal Runner-up (2013)", "Bundesliga Contender"],
    "individualAwards": ["La Liga Breakthrough Player (pre-Bayern recognition)"],
    "nationalTeamCaps": 22,
    "styleOfPlay": "A disciplined and intelligent defensive midfielder renowned for his tactical awareness, robust defensive abilities, and effective distribution. He is known for breaking up play and providing a reliable shield in front of the backline.",
    "legacyQuote": "Javi Martínez emerged as a model of modern defensive midfielding, blending physicality with remarkable game intelligence.",
    "rivalries": ["Opposing midfielders known for their technical flair in the Bundesliga"],
    "mentorOf": [],
    "inspiredBy": ["Xabi Alonso", "Luis Hernández"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/javi-martinez/profil/spieler/18745",
      "description": "Transfermarkt profile with career statistics and market value history."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/clubs/players/190817--javi-martinez/",
      "description": "UEFA profile detailing Javi Martínez's performances in European competitions."
    }
  ]
}
```
