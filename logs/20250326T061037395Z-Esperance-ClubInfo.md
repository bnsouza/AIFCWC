...
```
Provide the following details for the football club named Espérance (Tunisia - CAF):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/esperancetunis",
    "tiktok": "https://www.tiktok.com/@esperancetunis"
  },
  "colors": {
    "home": {
      "bgColor": "rgb(255, 0, 0)",
