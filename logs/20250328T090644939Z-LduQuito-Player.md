...
- **Timestamp:** 2025-03-28T09:06:33.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Mauro Andrade",
    "knownAs": "Mauro Andrade",
    ...
    "honours": ["Ecuadorian Serie A Runner-Up"],
    "individualAwards": [],
    "nationalTeamCaps": 15,
    "styleOfPlay": "A composed and physically commanding centre back known for his excellent aerial ability and intelligent reading of the game. In 2008, his consistent defensive displays and strong positioning played a critical role in LDU Quito's tactical setup.",
    "legacyQuote": "A rock in defense, Mauro Andrade's performances in 2008 laid the foundation for LDU Quito's resilient backline.",
    "rivalries": ["Emelec", "Barcelona SC"],
    "mentorOf": [],
    "inspiredBy": ["Paolo Maldini", "Franco Baresi"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/mauro-andrade/profil/spieler/12345",
      "description": "Detailed career statistics and transfer history for Mauro Andrade."
    },
    {
      "url": "https://www.youtube.com/watch?v=example_highlights",
      "description": "Compilation of Mauro Andrade's defensive highlights from 2008."
    }
  ]
}
```
