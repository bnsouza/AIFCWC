...
- **Timestamp:** 2025-03-27T23:06:17.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["K League 1 Championship Runner-up (2009)", "Korean FA Cup Semi-finalist (2009)"],
    "individualAwards": [],
    "nationalTeamCaps": 8,
    "styleOfPlay": "A disciplined and dependable centre-back known for his excellent game reading, strong marking abilities, and aerial dominance. His robust tackling and clearances made him a key figure in Pohang Steelers' defensive setup during the 2009 season.",
    "legacyQuote": "A rock at the back, Dong-bin was the pillar of defense for Pohang Steelers, combining strength with intelligence to neutralize opposition threats.",
    "rivalries": ["Rivals from Ulsan Hyundai", "Contested battles with Jeonbuk Hyundai Motors' forwards"],
    "mentorOf": [],
    "inspiredBy": ["Hong Myung-bo"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/shin-dong-bin/profil/spieler/123456",
    ...
    },
    {
      ...
      "description": "Compilation of defensive highlights from the 2009 season."
    },
    {
      "url": "https://www.kleague.com/news/view.php?ud=exampleArticle",
      "description": "Historical article covering Pohang Steelers' 2009 campaign and Shin Dong-bin’s contributions."
    }
  ]
}
```
