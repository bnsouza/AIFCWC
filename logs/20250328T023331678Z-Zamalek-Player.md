...
- **Timestamp:** 2025-03-28T02:33:17.000Z
...
-  Player Name: Abdel Rahman El-Said
-  Club: Zamalek
-  Year: 2016
-  Position: CM
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Egyptian Premier League", "Egypt Cup"],
    "individualAwards": ["Midfielder of the Season (2016)"],
    "nationalTeamCaps": 25,
    "styleOfPlay": "Abdel Rahman El-Said is known as a cerebral midfielder with excellent vision and composure under pressure. His ability to distribute the ball accurately and dictate the pace of the game was key to Zamalek's success in 2016, often linking defense with attack seamlessly.",
    "legacyQuote": "A true maestro in the midfield, El-Said's precise passes and tactical intelligence set the blueprint for modern Egyptian midfield play.",
    "rivalries": ["Al Ahly midfield battles"],
    "mentorOf": [],
    "inspiredBy": ["Mohamed Aboutrika"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/abdel-rahman-el-said/profil/spieler/123456",
      "description": "Transfermarkt profile for Abdel Rahman El-Said"
    },
    {
      "url": "https://www.zamalekclub.com/player/abdelrahmanelsaid",
      "description": "Profile on Zamalek's official website"
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlight reel of Abdel Rahman El-Said's 2016 season"
    }
  ]
}
```
