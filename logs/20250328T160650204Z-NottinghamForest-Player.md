...
- **Timestamp:** 2025-03-28T16:06:34.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Martin O'Neill",
    "knownAs": "Martin O'Neill",
    ...
    "honours": ["European Cup (1979)", "League Cup"],
    "individualAwards": [],
    "nationalTeamCaps": 47,
    "styleOfPlay": "A dynamic right midfielder known for incisive crosses, relentless work-rate, and tactical intelligence. In 1979, O'Neill combined technical skill with leadership on the pitch, contributing significantly to Nottingham Forest’s competitive edge.",
    "legacyQuote": "A player whose determination and passion on the right flank set the foundation for his later legendary managerial career.",
  ...
  "links": [
    {
      "url": "https://www.transfermarkt.com/martin-oneill/profil/spieler/12345",
      "description": "Transfermarkt profile of Martin O'Neill with career statistics."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Martin_O%27Neill",
      "description": "Detailed Wikipedia article on Martin O'Neill's career and legacy."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/news/0195-0e6a6ddf8875-4e1f5e1b8f0f-1000--legendary-forest-moments/",
      "description": "UEFA article highlighting Nottingham Forest's European Cup success in 1979."
    }
  ]
}
```
