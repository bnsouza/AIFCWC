...
- **Timestamp:** 2025-03-28T03:18:17.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["European Cup 1967", "Scottish League Title 1967", "Scottish Cup 1967"],
    "individualAwards": ["Celtic Player of the Year (1967)"],
    "nationalTeamCaps": 22,
    "styleOfPlay": "A technically gifted central midfielder known for his exceptional vision, precise distribution, and ability to dictate the tempo of the game. His intelligent playmaking and creative passing were key factors in Celtic's historical success during the 1967 season.",
    "legacyQuote": "A true architect in midfield, George Connelly's playmaking prowess laid the foundation for Celtic's memorable triumphs in 1967.",
    "rivalries": ["Rangers"],
    "mentorOf": ["Emerging Scottish midfield talents"],
    "inspiredBy": ["Earlier Scottish midfield legends"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/george-connelly/profil/spieler/12345",
      "description": "Transfermarkt profile providing detailed career statistics and market value history."
    },
    {
      "url": "https://www.youtube.com/results?search_query=George+Connelly+Celtic+1967",
      "description": "Video highlights and historical match footage of George Connelly during his time with Celtic in 1967."
    }
  ]
}
```
