...
- **Timestamp:** 2025-03-28T18:05:25.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Bundesliga Champion (2012–13)"],
    "individualAwards": ["kicker Team of the Season"],
    "nationalTeamCaps": 81,
    "styleOfPlay": "Explosive winger with exceptional dribbling ability, creativity, and pace. Ribéry's quick feet and technical skill allowed him to consistently beat defenders and create scoring opportunities from the left flank.",
    "legacyQuote": "Franck Ribéry redefined modern wing play with his electrifying dribbles and relentless attacking spirit.",
    "rivalries": ["Opposing full-backs in Bundesliga battles"],
    "mentorOf": [],
    "inspiredBy": ["Zinedine Zidane"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/franck-ribery/profil/spieler/3529",
      "description": "Franck Ribéry's detailed career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/history/clubs/50055--bayern-munich/",
      "description": "Historical overview of FC Bayern Munich's performances in the UEFA Champions League, featuring Ribéry's contributions."
    },
    {
      "url": "https://www.youtube.com/watch?v=zgLn0WpH1p0",
      "description": "Highlight reel showcasing Franck Ribéry's mesmerizing dribbling and playmaking abilities."
    }
  ]
}
```
