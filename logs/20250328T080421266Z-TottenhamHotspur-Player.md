...
- **Timestamp:** 2025-03-28T08:04:06.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Serge Toussaint Aurier",
    "knownAs": "Serge Aurier",
    ...
    "honours": ["Ligue 1 Winner (with PSG)"],
    "individualAwards": [],
    "nationalTeamCaps": 60,
    "styleOfPlay": "A defensive-minded fullback known for his aggressive tackling, physicality, and ability to support the attack with rapid overlaps. In 2019 at Tottenham, his performances were marked by a combination of endurance, robust defending, and timely offensive contributions, despite occasional lapses in decision-making.",
    "legacyQuote": "Aurier's robustness and passion on the right flank made him a formidable presence at Spurs, even if his off-field controversies sometimes overshadowed his talent.",
    "rivalries": ["Opposing wingers known for their pace and skill"],
    "mentorOf": [],
    "inspiredBy": ["Dani Alves"]
  },
  "links": [
    {
      "url": "https://www.youtube.com/watch?v=example_highlights",
      "description": "Serge Aurier 2019 Season Highlights at Tottenham Hotspur"
    },
    {
      "url": "https://www.transfermarkt.com/serge-aurier/profil/spieler/12345",
      "description": "Detailed career statistics and transfer history on Transfermarkt"
    },
    {
      "url": "https://www.national-football-teams.com/player/1234/Serge_Aurier.html",
      "description": "International career statistics and profile on National Football Teams"
    }
  ]
}
```
