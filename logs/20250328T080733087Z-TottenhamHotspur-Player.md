...
- **Timestamp:** 2025-03-28T08:07:20.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Tottenham Hotspur Player of the Year"],
    "nationalTeamCaps": 50,
    "styleOfPlay": "A prolific striker known for his clinical finishing, intelligent positioning, and aerial prowess. Combines physical strength with technical ability to excel in both hold-up play and quick counter-attacks.",
    "legacyQuote": "A modern striker who blends technical skill with relentless determination, always finding the back of the net when it matters most.",
    "rivalries": ["Sergio Aguero", "Robert Lewandowski"],
    "mentorOf": [],
    "inspiredBy": ["Alan Shearer", "Thierry Henry"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/harry-kane/profil/spieler/370747",
      "description": "Detailed statistical profile and career history of Harry Kane on Transfermarkt."
    },
    {
      "url": "https://www.tottenhamhotspur.com/teams/first-team/players/harry-kane/",
      "description": "Official profile of Harry Kane on the Tottenham Hotspur website."
    },
    {
      "url": "https://www.youtube.com/watch?v=Uq0dSxS7H6Q",
      "description": "Compilation of career highlights showcasing Harry Kane's clinical finishing and positioning."
    }
  ]
}
```
