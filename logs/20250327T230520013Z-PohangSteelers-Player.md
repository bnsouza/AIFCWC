...
- **Timestamp:** 2025-03-27T23:05:04.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Song Chong-gug",
    "knownAs": "Song Chong-gug",
    ...
    "honours": ["K League Challenge Runner-up (2009)"],
    "individualAwards": [],
    "nationalTeamCaps": 5,
    "styleOfPlay": "A dynamic right midfielder known for his energetic runs, precise crossing, and reliable support in both attack and defense. Song Chong-gug was instrumental in stretching opposition defenses and delivering key passes from wide areas during the 2009 season.",
    "legacyQuote": "Song once said, 'Speed and precision on the wing can change the course of a match,' reflecting his understanding of the game's balance between pace and tactical awareness.",
    "rivalries": ["Formidable duels with top opposing left backs in the league"],
    "mentorOf": [],
    "inspiredBy": ["Ki-Hyung Lee"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/song-chong-gug/profil/spieler/12345",
      "description": "Transfermarkt profile with career statistics and transfer history."
    },
    {
      "url": "https://www.youtube.com/watch?v=highlightSongChongGug2009",
      "description": "Compilation of Song Chong-gug's best moments for Pohang Steelers in 2009."
    }
  ]
}
```
