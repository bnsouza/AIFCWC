...
- **Timestamp:** 2025-03-28T04:03:13.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Ligue 1 Title", "Coupe de France", "Coupe de la Ligue"],
    "individualAwards": ["Ligue 1 Team of the Year"],
    "nationalTeamCaps": 50,
    "styleOfPlay": "A modern, versatile, and intelligent center-back known for his excellent positioning, tactical awareness, and ability to initiate play from the back. His calmness under pressure and strong defensive skills make him a key figure in PSG's backline during the 2020 season.",
    "legacyQuote": "An embodiment of composure and determination, Marquinhos has redefined defensive excellence in modern football.",
    "rivalries": ["Bayern Munich"],
    "mentorOf": [],
    "inspiredBy": ["Thiago Silva"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/marquinhos/profil/spieler/153881",
      "description": "Detailed career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
      "description": "Highlights and key moments of Marquinhos during his time at PSG."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/clubs/players/101",
      "description": "UEFA profile and performance review in Champions League competitions."
    }
  ]
}
```
