...
- **Timestamp:** 2025-03-28T18:04:04.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Jérôme Agyenim Boateng",
    "knownAs": "Boateng",
    ...
    "honours": ["Bundesliga Champion", "UEFA Champions League Winner (2013)", "DFB-Pokal Winner"],
    "individualAwards": ["DFB Team of the Season"],
    "nationalTeamCaps": 40,
    "styleOfPlay": "A robust and versatile center-back known for his impeccable positioning and aerial ability. Combining physical power with refined technical skills, Boateng excelled as a ball-playing defender, contributing to both defensive solidity and initiating attacks from the back.",
    "legacyQuote": "An embodiment of defensive excellence and versatility, Boateng redefined the modern center-back role with his intelligence and physical presence.",
    "rivalries": [
      "Rivalries with top international forwards and defenders, often marking key opponents in high-stakes games"
    ],
    "mentorOf": [],
    "inspiredBy": ["Former greats of defensive football and emerging tactical systems in modern football"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jerome-boateng/profil/spieler/20531",
      "description": "Transfermarkt profile with detailed career statistics and transfer history."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/news/newsid=1965572.html",
      "description": "UEFA article analyzing FC Bayern Munich's Champions League campaign in 2013."
    }
  ]
}
```
