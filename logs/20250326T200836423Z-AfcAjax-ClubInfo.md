## AI Generation Log: AfcAjax-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-26T20:08:34.000Z
...
```
Provide the following details for the football club named AFC Ajax (Netherlands - UEFA):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    ...
    "tiktok": "https://www.tiktok.com/@afcajax"
  },
  "colors": {
    "home": {
      "bgColor": "rgb(255, 0, 0)",
