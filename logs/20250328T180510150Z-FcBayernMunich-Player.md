...
- **Timestamp:** 2025-03-28T18:04:54.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Bundesliga Champion", "DFB-Pokal Winner", "UEFA Champions League Finalist"],
    "individualAwards": ["German Footballer of the Year Nominee"],
    "nationalTeamCaps": 116,
    "styleOfPlay": "A box-to-box midfielder known for his tactical intelligence, precise passing, and commanding leadership in the heart of midfield. He was instrumental in linking defense with attack while maintaining structure.",
    "legacyQuote": "Bastian Schweinsteiger defined the modern midfield with his vision and relentless work ethic, inspiring a generation of players.",
    "rivalries": ["Opposing elite midfielders in Europe, often clashing in tactical battles on the biggest stages."],
    "mentorOf": [],
    "inspiredBy": ["Lothar Matthäus"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/bastian-schweinsteiger/profil/spieler/6701",
      "description": "Comprehensive career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.uefa.com/insideuefa/news/newsid=2117581.html",
      "description": "UEFA article analyzing Schweinsteiger's impact and leadership at Bayern Munich."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlights showcasing Schweinsteiger's career-defining moments."
    }
  ]
}
```
