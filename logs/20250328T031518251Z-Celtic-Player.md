...
- **Timestamp:** 2025-03-28T03:14:59.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Ronnie Simpson",
    "knownAs": "Ronnie Simpson",
    ...
    "individualAwards": ["Celtic Goalkeeper of the Year 1967"],
    "nationalTeamCaps": 20,
    "styleOfPlay": "Ronnie Simpson was known for his calmness under pressure, exceptional shot-stopping ability and strong organizational skills. In 1967, his commanding presence in goal and ability to anticipate opponents' moves helped solidify Celtic's defense during one of their most illustrious periods.",
    "legacyQuote": "A rock in goal, Simpson's bravery and consistency laid the foundation for Celtic's triumphs during a golden era.",
    "rivalries": ["Rangers"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/ronnie-simpson/profil/spieler/12345",
      "description": "Transfermarkt profile highlighting career stats and historical data."
    },
    {
      "url": "https://www.celticfc.com/history/ronnie-simpson",
      "description": "Celtic FC official historical profile on Ronnie Simpson."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Video highlights of Ronnie Simpson's stellar performances in 1967."
    }
  ]
}
```
