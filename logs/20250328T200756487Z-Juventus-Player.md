...
- **Timestamp:** 2025-03-28T20:07:18.000Z
...
-  Player Name: Fabrizio Ravanelli
-  Club: Juventus
-  Year: 1996
-  Position: ST
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 21,
    "styleOfPlay": "An aggressive and clinical striker known for his sharp positioning, aerial ability, and lethal finishing. Ravanelli combined a robust physical presence with technical precision, often rising to the occasion in crucial moments.",
    "legacyQuote": "A goal machine with a heart of a lion, Ravanelli’s trademark determination and clutch performances defined a generation.",
    "rivalries": ["Italian Defenders", "Top-tier Milan rivals"],
    "mentorOf": [],
    "inspiredBy": ["Roberto Baggio", "Gianluca Vialli"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/fabrizio-ravanelli/profil/spieler/12224",
      "description": "Transfermarkt profile with detailed career stats and historical data."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/history/",
      "description": "UEFA Champions League historical archive featuring the 1996 season and related match highlights."
    }
  ]
}
```
