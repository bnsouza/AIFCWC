## AI Generation Log: Chelsea-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-28T12:01:58.000Z
...
```
Provide the following details for the football club named Chelsea (England - UEFA):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    ...
    "tiktok": "https://www.tiktok.com/@chelseafc"
  },
  "colors": {
    "home": {
