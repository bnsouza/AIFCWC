...
- **Timestamp:** 2025-03-28T18:03:14.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Bundesliga Champion", "DFB-Pokal Winner", "UEFA Champions League Winner", "FIFA World Cup Winner"],
    "individualAwards": ["German Footballer of the Year"],
    "nationalTeamCaps": 100,
    "styleOfPlay": "A versatile and intelligent fullback known for his exceptional reading of the game, precise passing, and tireless work rate. Lahm excelled at both defensive discipline and contributing to offensive plays, making him indispensable in high-stakes matches.",
    "legacyQuote": "A captivating leader and model professional whose career epitomizes discipline, versatility, and commitment.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Cafu", "Lilian Thuram"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/philipp-lahm/profil/spieler/1060",
      "description": "Detailed career statistics and transfer history of Philipp Lahm."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Philipp_Lahm",
      "description": "Comprehensive biography and career overview on Wikipedia."
    }
  ]
}
```
