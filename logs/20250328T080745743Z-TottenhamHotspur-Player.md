...
- **Timestamp:** 2025-03-28T08:07:33.000Z
...
```json
{
  ...
  "history": {
    ...
    "career": [
      ...
      {
        "club": "Previous Clubs (Various Loan Spells)",
        "from": 2012,
        "to": 2019,
        "appearances": 100,
        "goals": 0,
    ...
    "individualAwards": [],
    "nationalTeamCaps": 0,
    "styleOfPlay": "A reactive goalkeeper known for his shot-stopping abilities and quick reflexes. Although primarily a backup at Tottenham in 2019, he demonstrated readiness to step in during crucial moments. His command of the penalty area and consistent performances in training highlighted his potential as a reliable option between the sticks.",
    "legacyQuote": "A reliable presence in goal who was always prepared to answer the call, embodying the role of the steadfast backup goalkeeper.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Gianluigi Buffon"]
  },
  "links": [
    {
      "url": "https://en.wikipedia.org/wiki/Paulo_Gazzaniga",
      "description": "Wikipedia page detailing Paulo Gazzaniga's career and biography."
    },
    {
      "url": "https://www.transfermarkt.com/paulo-gazzaniga/profil/spieler/132684",
      "description": "Transfermarkt profile with comprehensive career statistics and transfer history."
    }
  ]
}
```
