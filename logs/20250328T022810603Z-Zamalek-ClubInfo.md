## AI Generation Log: Zamalek-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-28T02:28:09.000Z
...
```
Provide the following details for the football club named Zamalek (Egypt - CAF):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/zamaleksc/",
    "tiktok": "https://www.tiktok.com/@zamaleksc"
  },
  "colors": {
    "home": {
