...
- **Timestamp:** 2025-03-28T02:32:31.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Egypt Cup: 2016"],
    "individualAwards": [],
    "nationalTeamCaps": 12,
    "styleOfPlay": "A dynamic and pacey striker known for his intelligent positioning and clinical finishing ability. He combines speed with an incisive sense for goal, often finding space in crowded penalty areas.",
    "legacyQuote": "A natural finisher with an eye for goal, Kahraba electrified the Egyptian pitch in 2016 with his relentless drive and sharp instincts in front of goal.",
    "rivalries": ["Al Ahly strikers"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/mahmooud-kahraba/profil/spieler/xxx",
      "description": "Transfermarkt profile for Mahmoud Kahraba detailing his career statistics and market history."
    },
    {
      "url": "https://www.youtube.com/results?search_query=Mahmoud+Kahraba+Zamalek+2016",
      "description": "Video compilation of Mahmoud Kahraba's highlights from the 2016 season with Zamalek."
    },
    {
      "url": "https://www.national-football-teams.com/player/xxx/Mahmoud_Kahraba.html",
      "description": "National-Football-Teams.com profile outlining his international career and stats."
    }
  ]
}
```
