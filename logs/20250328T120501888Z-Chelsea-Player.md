...
- **Timestamp:** 2025-03-28T12:04:47.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["FA Cup Runner-up (2011-2012)"],
    "individualAwards": ["Chelsea Goal of the Month (Feb 2012)"],
    "nationalTeamCaps": 26,
    "styleOfPlay": "A creative and intelligent winger known for his precise dribbling, excellent ball control, and insightful passing. Mata is recognized for his ability to unlock defenses and contribute significantly to build-up play.",
    "legacyQuote": "His intelligence on the pitch and splendid technical ability have always set him apart, making him a cherished playmaker in midfield and on the wing.",
    "rivalries": [
      "Rivalry with top English wingers, particularly those from Arsenal, due to competing styles and performances."
    ],
    "mentorOf": ["Emerging Spanish talents at Chelsea"],
    "inspiredBy": ["Ronaldinho", "Zinedine Zidane"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/juan-mata/profil/spieler/37386",
      "description": "Juan Mata Transfermarkt profile with career statistics and history."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlights from Juan Mata's 2012 season at Chelsea."
    }
  ]
}
```
