...
- **Timestamp:** 2025-03-28T07:03:26.000Z
...
-  Player Name: Abdelaziz Al-Baloushi
-  Club: Al Sadd
-  Year: 2018
-  Position: RB
...
```json
{
  ...
  "history": {
    "fullName": "Abdelaziz Al-Baloushi",
    "knownAs": "Al-Baloushi",
    ...
    "honours": ["Qatar Stars League Champion (2018)", "Emir of Qatar Cup (2018)"],
    "individualAwards": [],
    "nationalTeamCaps": 20,
    "styleOfPlay": "A disciplined and energetic right-back known for his solid defensive contributions and ability to support the attack with precise crosses and timely overlapping runs. His tactical awareness and consistent performance make him a key asset for Al Sadd.",
    "legacyQuote": "A catalyst on the flank who combined defensive solidity with attacking flair, embodying the spirit and determination of Al Sadd in 2018.",
    "rivalries": ["Al Rayyan", "Al Duhail"],
    "mentorOf": [],
    "inspiredBy": ["Former Al Sadd right-backs and international defenders"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/abdelaziz-al-baloushi/profil/spieler/123456",
      "description": "Detailed statistical profile of Abdelaziz Al-Baloushi on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=abcdEFGhijk",
      "description": "Highlights of Abdelaziz Al-Baloushi's 2018 season performances with Al Sadd."
    }
  ]
}
```
