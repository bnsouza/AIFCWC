...
- **Timestamp:** 2025-03-28T01:32:30.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Emir Bajrami",
    "knownAs": "Emir Bajrami",
    ...
    "honours": ["Süper Lig Runners-up 2011-12", "Turkish Cup Runners-up 2011-12"],
    "individualAwards": ["Swedish Newcomer of the Year"],
    "nationalTeamCaps": 20,
    "styleOfPlay": "Emir Bajrami was known for his explosive pace and technical ability on the ball. In the 2012 season with Fenerbahçe, he played as a striker who combined intelligent off-the-ball movement with precise finishing, making him a constant threat inside the box despite his occasional injury setbacks.",
    "legacyQuote": "A promising striker whose flashes of brilliance were often overshadowed by recurring injuries, yet his speed and positioning made him a standout talent in his prime.",
    "rivalries": ["Defenders known for their physicality and disciplined marking"],
    "mentorOf": [],
    "inspiredBy": ["Zlatan Ibrahimović"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/emir-bajrami/profil/spieler/12010",
      "description": "Transfermarkt profile for detailed career statistics and history."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Emir_Bajrami",
      "description": "Wikipedia page providing an overview of his career and biography."
    }
  ]
}
```
