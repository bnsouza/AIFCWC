...
- **Timestamp:** 2025-03-28T08:05:10.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["UEFA Champions League Runner-up (2018-19)"],
    "individualAwards": [],
    "nationalTeamCaps": 30,
    "styleOfPlay": "Danny Rose is a defensively solid left-back known for his disciplined tackling, strong marking, and commitment to team organization. In 2019, he demonstrated consistent performances, balancing his defensive duties with timely support in attack.",
    "legacyQuote": "Danny Rose's reliability on the left flank, marked by his tenacious defending and smart positioning, has made him a respected figure at Tottenham Hotspur.",
    "rivalries": ["Notable battles against top opposing wingers and attacking full-backs in the Premier League"],
    "mentorOf": [],
    "inspiredBy": ["Former England left-backs like Ashley Cole"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/danny-rose/profil/spieler/12065",
      "description": "Detailed player statistics and career history on Transfermarkt."
    },
    {
      "url": "https://www.tottenhamhotspur.com/teams/first-team/players/danny-rose/",
      "description": "Official profile and career highlights on Tottenham Hotspur's website."
    },
    {
      "url": "https://www.premierleague.com/players/2716/Danny-Rose/overview",
      "description": "Premier League profile with match stats and performance data."
    }
  ]
}
```
