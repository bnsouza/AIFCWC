...
- **Timestamp:** 2025-03-28T02:29:35.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Egyptian Premier League", "Egyptian Cup", "CAF Champions League Runner-Up"],
    "individualAwards": ["Egyptian Goalkeeper of the Year"],
    "nationalTeamCaps": 159,
    "styleOfPlay": "A commanding and experienced shot-stopper, Essam is known for his exceptional reflexes and leadership. Even in the later stages of his career, his ability to make crucial saves and organize the defense stands out.",
    "legacyQuote": "I have always believed that age is just a number and that experience outshines youth.",
    "rivalries": ["Rivals with emerging goalkeeping talents in African football"],
    "mentorOf": ["Mohamed El-Shenawy"],
    "inspiredBy": ["Neville Southall", "Peter Schmeichel"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/essam-el-hadary/profil/spieler/3468",
      "description": "Detailed career statistics and transfer history for Essam El-Hadary on Transfermarkt."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Essam_El-Hadary",
