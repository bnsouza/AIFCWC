...
- **Timestamp:** 2025-03-28T09:07:00.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Jaime Ayoví",
    "knownAs": "El Depredador del Área",
    ...
    "individualAwards": ["Best Striker 2008 (Nomination)"],
    "nationalTeamCaps": 10,
    "styleOfPlay": "A dynamic and opportunistic striker known for his excellent positioning and clinical finishing. Ayoví uses his speed and intelligent movement to exploit defensive gaps, making him a constant aerial and poaching threat in the opposition’s box.",
    "legacyQuote": "A relentless predator in the penalty area with an innate knack for goals.",
    "rivalries": ["Barcelona SC"],
    "mentorOf": [],
    "inspiredBy": ["Classic South American poachers"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jaime-ayovi/profil/spieler/12345",
      "description": "Transfermarkt profile for Jaime Ayoví with career statistics and transfer history."
    },
    {
      "url": "https://www.youtube.com/watch?v=exampleJaimeAyoviHighlights",
      "description": "Highlight reel showcasing Jaime Ayoví's performance during the 2008 season with LDU Quito."
    }
  ]
}
```
