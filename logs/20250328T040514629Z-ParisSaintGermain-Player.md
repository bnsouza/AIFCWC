...
- **Timestamp:** 2025-03-28T04:04:53.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Angel Florencio Di Maria",
    "knownAs": "Di Maria",
    ...
    "honours": [
      "Ligue 1 Title (multiple seasons including 2020)",
      "Coupe de France",
      "Coupe de la Ligue",
    ...
    "styleOfPlay": "A dynamic and creative right midfielder known for his exceptional dribbling, precise crosses, and incisive through passes. In 2020 at PSG, Di Maria consistently provided key assists while exploiting space on the flank, making him a vital part of the team’s attacking prowess.",
    "legacyQuote": "A master on the wing whose creativity and vision have redefined the role of a modern wide midfielder.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/angel-di-maria/profil/spieler/14645",
      "description": "Detailed career stats and transfer history for Angel Di Maria."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Angel_Di_Maria",
      "description": "Comprehensive biography and career overview on Wikipedia."
    },
    {
      "url": "https://en.psg.fr/",
      "description": "Official website of Paris Saint-Germain."
    }
  ]
}
```
