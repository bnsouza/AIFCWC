...
- **Timestamp:** 2025-03-27T23:05:20.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["K League Cup Winner (2009)", "K-League Best Eleven (2009)"],
    "individualAwards": ["K-League Best Eleven (2009)"],
    "nationalTeamCaps": 18,
    "styleOfPlay": "Jung Dae-sung is an intelligent playmaker known for his incisive through passes and long-range shooting. In 2009, he orchestrated the midfield with vision and technical finesse, linking defense to attack and creating numerous scoring opportunities.",
    "legacyQuote": "A midfield genius who orchestrated the flow of the game with precise passing and an uncanny ability to spot openings.",
    "rivalries": [
      "Competitive duels with top K-League creative midfielders",
      "Rivalry against Jeonbuk Hyundai's playmakers"
    ],
    "mentorOf": ["Emerging young midfield talents in South Korea"],
    "inspiredBy": ["Zinedine Zidane", "Dennis Bergkamp"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jung-dae-sung/profil/spieler/12345",
      "description": "Statistical profile and career history on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=EXAMPLE",
      "description": "Highlights of Jung Dae-sung's performances in 2009."
    }
  ]
}
```
