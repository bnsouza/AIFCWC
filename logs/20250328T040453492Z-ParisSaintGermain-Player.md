...
- **Timestamp:** 2025-03-28T04:04:31.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Ligue 1 Champion (2019-20)", "Coupe de France (2019-20)", "Trophée des Champions (2019)"],
    "individualAwards": [],
    "nationalTeamCaps": 38,
    "styleOfPlay": "A composed and tactically intelligent midfielder, Leandro Paredes is known for anchoring the midfield with excellent passing and disciplined defensive work. His ability to read the game and lie deep to orchestrate play makes him a reliable CDM.",
    "legacyQuote": "A master of balance in midfield, Paredes’ composure under pressure and intelligent distribution define his contribution to the team.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Andrea Pirlo", "Xavi Hernandez"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/leandro-paredes/profil/spieler/237777",
      "description": "Transfermarkt profile featuring detailed career stats and transfer history."
    },
    {
      "url": "https://www.national-football-teams.com/player/82955/Leandro_Paredes.html",
      "description": "National Football Teams profile with international career information."
    },
    {
      "url": "https://www.psg.fr/en/teams/first-team",
      "description": "Official PSG first-team overview providing current news and player profiles."
    }
  ]
}
```
