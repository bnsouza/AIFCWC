...
- **Timestamp:** 2025-03-27T23:03:24.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Jung Sung-ryong",
    "knownAs": "Jung Sung-ryong",
    ...
    "individualAwards": [],
    "nationalTeamCaps": 10,
    "styleOfPlay": "A composed and agile goalkeeper known for his excellent reflexes and command of his penalty area. In 2009, his performances for Pohang Steelers showcased a reliable ability to come off his line and make crucial saves, balancing traditional shot-stopping with emerging distribution skills.",
    "legacyQuote": "A reliable guardian between the posts, setting the foundation for future success in South Korean goalkeeping.",
    "rivalries": [],
    "mentorOf": [],
  ...
  "links": [
    {
      "url": "https://www.transfermarkt.com/jung-sung-ryong/profil/spieler/8272",
      "description": "Career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/results?search_query=Jung+Sung-ryong+2009",
      "description": "Video highlights from Jung Sung-ryong's 2009 season."
    }
  ]
}
```
