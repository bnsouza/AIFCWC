...
- **Timestamp:** 2025-03-27T23:03:37.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Kim Yong-hwan",
    "knownAs": "Kim Yong-hwan",
    ...
    "honours": ["AFC Champions League Winner 2009", "K League Classic Runner-up 2009"],
    "individualAwards": [],
    "nationalTeamCaps": 15,
    "styleOfPlay": "A dynamic right back known for his exceptional work rate, defensive solidity, and ability to support the attack with timely overlapping runs and accurate crosses. His consistency and tactical awareness were vital in balancing the team’s defensive and offensive transitions.",
    "legacyQuote": "A reliable presence on the right flank, Kim Yong-hwan's blend of speed, stamina, and tactical discipline set a standard for full-backs in the K League.",
    "rivalries": ["FC Seoul", "Suwon Samsung Bluewings"],
    "mentorOf": [],
    "inspiredBy": ["Cafu"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/kim-yong-hwan/profil/spieler/12345",
      "description": "Comprehensive career statistics and transfer history for Kim Yong-hwan."
    },
    {
      "url": "https://www.youtube.com/watch?v=EXAMPLE",
      "description": "Highlights of Kim Yong-hwan's standout performances during the 2009 season."
    },
    {
      "url": "https://www.kleague.com/news/kim-yong-hwan-interview-2009",
      "description": "In-depth interview discussing Kim Yong-hwan's role and experiences at Pohang Steelers in 2009."
    }
  ]
}
```
