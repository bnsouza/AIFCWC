...
- **Timestamp:** 2025-03-28T09:04:36.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Édison Alberto Méndez",
    "knownAs": "Édison Méndez",
    ...
    "honours": ["2008 Copa Libertadores", "2008 Recopa Sudamericana"],
    "individualAwards": ["Man of the Match (multiple instances)"],
    "nationalTeamCaps": 78,
    "styleOfPlay": "A dynamic central midfielder known for his precise passing, creative vision, and ability to dictate the tempo of the game. His exceptional playmaking skills allowed him to control the midfield and create numerous scoring opportunities.",
    "legacyQuote": "A maestro in midfield, Édison Méndez redefined playmaking with his intelligent vision and incisive passes.",
    "rivalries": ["Barcelona SC"],
    "mentorOf": [],
    "inspiredBy": ["Juan Carlos Letort"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/edison-mendez/profil/spieler/1241",
      "description": "Detailed player statistics and career information on Transfermarkt."
    },
    {
      "url": "https://www.national-football-teams.com/player/2040/Edson_Mendez.html",
      "description": "International career stats and profile on National-Football-Teams.com."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlights from Édison Méndez's performances during the 2008 Copa Libertadores campaign."
    }
  ]
}
```
