...
- **Timestamp:** 2025-03-28T03:16:23.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Bobby Murdoch",
    "knownAs": "Bobby Murdoch",
    ...
    "honours": ["European Cup 1967", "Scottish League Championship", "Scottish Cup", "Scottish League Cup"],
    "individualAwards": ["Lisbon Lions"],
    "nationalTeamCaps": 26,
    "styleOfPlay": "A combative and tactically astute midfielder, Bobby Murdoch was known for his exceptional ability to break up play and offer balance between defense and attack. In 1967, his consistent performances and intelligent positioning were pivotal in Celtic's European and domestic successes.",
    "legacyQuote": "Bobby Murdoch left an indelible mark on Celtic's history with his tireless work ethic, impeccable positional sense, and unyielding commitment on the pitch.",
    "rivalries": ["Rangers"],
    "mentorOf": [],
    "inspiredBy": ["Billy McNeill", "Jimmy Johnstone"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/bobby-murdoch/profil/spieler/12345",
      "description": "Transfermarkt profile providing detailed career stats and market value history."
    },
    {
      "url": "https://www.youtube.com/watch?v=LisbonLions1967",
      "description": "Highlight reel from Celtic’s iconic 1967 European Cup-winning campaign."
    }
  ]
}
```
