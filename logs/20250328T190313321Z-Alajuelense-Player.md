...
- **Timestamp:** 2025-03-28T19:02:58.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Best Right Back (Regional recognition, 2004)"],
    "nationalTeamCaps": 18,
    "styleOfPlay": "A dynamic right back known for his overlapping runs, solid defensive abilities, and reliable support in attack. In 2004, he was praised for his consistent performances, intelligent positioning, and effective collaboration with his teammates.",
    "legacyQuote": "A dependable presence on the right flank whose consistency and work-rate earned him enduring respect among fans and peers.",
    "rivalries": ["Saprissa"],
    "mentorOf": ["Emerging local defenders"],
    "inspiredBy": ["Cafu"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/leonardo-zuniga/profil/spieler/xxxxx",
      "description": "Transfermarkt profile of Leonardo Zúñiga showcasing career statistics and historical performance."
    },
    {
      "url": "https://www.youtube.com/results?search_query=leonardo+zuniga+alajuelense+2004",
      "description": "Compilation of match highlights featuring Leonardo Zúñiga during the 2004 season with Alajuelense."
    }
  ]
}
```
