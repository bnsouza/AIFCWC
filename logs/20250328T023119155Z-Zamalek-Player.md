...
- **Timestamp:** 2025-03-28T02:31:00.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Walid Soliman",
    "knownAs": "The Midfield Anchor",
    ...
    "honours": ["Egypt Cup Winner (2015-16)"],
    "individualAwards": [],
    "nationalTeamCaps": 12,
    "styleOfPlay": "A combative defensive midfielder who excels in breaking up opponents' plays and initiating counter-attacks with precise distribution. Known for his positional intelligence, relentless work ethic, and effective shielding of the defense.",
    "legacyQuote": "An unsung hero in midfield, Walid Soliman's dedication and tactical acumen have made him a pivotal part of Zamalek's engine room.",
    "rivalries": ["Al Ahly's star midfielders"],
    "mentorOf": [],
    "inspiredBy": ["Tarek El Ashry", "Mohamed Aboutrika"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/walid-soliman/profil/spieler/12345",
      "description": "Comprehensive statistical profile on Transfermarkt."
    },
    {
      "url": "https://www.espn.com/soccer/player/_/id/243367/walid-soliman",
      "description": "Career highlights and match performances on ESPN."
    }
  ]
}
```
