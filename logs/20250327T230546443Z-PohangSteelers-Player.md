...
- **Timestamp:** 2025-03-27T23:05:33.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 5,
    "styleOfPlay": "Kim Tae-sung is a creative left midfielder known for his precise crosses, excellent ball control, and tireless runs down the flank. In 2009, his work rate and ability to link up play were key to Pohang Steelers’ tactical approach, providing width and quick transitions in attack.",
    "legacyQuote": "An unsung hero on the left flank, Kim Tae-sung combined creativity with relentless energy, leaving a lasting impact on every match he played.",
    "rivalries": ["Jeonbuk Motors"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/kim-tae-sung/profil/spieler/000000",
      "description": "Transfermarkt profile with detailed career statistics for Kim Tae-sung."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlight reel showcasing Kim Tae-sung's performance during the 2009 season."
    }
  ]
}
```
