...
- **Timestamp:** 2025-03-28T08:08:24.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 20,
    "styleOfPlay": "An elegant attacking midfielder known for his creativity, flair, and the ability to score stunning long-range goals with his left foot. Lamela excels in tight spaces, orchestrating the offense with incisive through passes and smart movement off the ball.",
    "legacyQuote": "A magician in midfield, Lamela's vision and audacious flair made him a standout in the Spurs lineup.",
    "rivalries": ["Notable on-field battles against top-tier defenders from rival clubs like Manchester City"],
    "mentorOf": [],
    "inspiredBy": ["Diego Maradona", "Juan Román Riquelme"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/erik-lamela/profil/spieler/15982",
      "description": "Transfermarkt profile providing detailed career stats for Erik Lamela."
    },
    {
      "url": "https://www.tottenhamhotspur.com/teams/first-team/erik-lamela/",
      "description": "Official Tottenham Hotspur profile of Erik Lamela."
    },
    {
      "url": "https://www.youtube.com/watch?v=sample_highlight",
      "description": "Highlights of Erik Lamela's skill and flair during his tenure at Tottenham."
    }
  ]
}
```
