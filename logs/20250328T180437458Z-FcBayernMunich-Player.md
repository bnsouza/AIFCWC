...
- **Timestamp:** 2025-03-28T18:04:21.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 15,
    "styleOfPlay": "A dynamic and versatile left-back, Alaba combines robust defensive skills with creative attacking support. In 2013, his excellent ball control, intelligent positioning, and ability to contribute to both defensive stability and offensive transitions set him apart.",
    "legacyQuote": "A player with immense talent who would later transform the modern full-back role with his all-round ability.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Paolo Maldini", "Roberto Carlos"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/david-alaba/profil/spieler/64055",
      "description": "David Alaba career statistics and market value on Transfermarkt."
    },
    {
      "url": "https://www.uefa.com/teamsandplayers/players/player=250029859/profile/index.html",
      "description": "UEFA profile detailing David Alaba's performances in European competitions."
    }
  ]
}
```
