...
- **Timestamp:** 2025-03-28T03:18:31.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Top Scorer Award"],
    "nationalTeamCaps": 10,
    "styleOfPlay": "A clinical striker renowned for his exceptional finishing, intelligent positioning, and aerial prowess. Jim Forrest excelled with his steady composure in front of goal and ability to make the most of critical scoring opportunities.",
    "legacyQuote": "A consummate forward who always found the back of the net, embodying the Celtic spirit in every match.",
    "rivalries": ["Rangers"],
    "mentorOf": [],
    "inspiredBy": ["Jimmy McGrory"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jim-forrest/profil/spieler/12345",
      "description": "Transfermarkt profile of Jim Forrest detailing his career statistics and historical data."
    },
    {
      "url": "https://www.national-football-teams.com/player/12345/Jim_Forrest.html",
      "description": "National Football Teams profile for Jim Forrest highlighting his international appearances."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Video highlights of Jim Forrest's performances with Celtic in 1967."
    }
  ]
}
```
