...
- **Timestamp:** 2025-03-28T19:05:31.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Rafael Bolaños",
    "knownAs": "Rafa Bolaños",
    ...
    "honours": ["Costa Rican Primera División Title (2004)", "CONCACAF Champions League Runner-up (2004)"],
    "individualAwards": ["Best Goalkeeper of the Season (2004)"],
    "nationalTeamCaps": 20,
    "styleOfPlay": "A commanding and agile goalkeeper known for his excellent shot-stopping abilities and strong leadership in organizing the defense. In 2004, his consistent performances and crucial saves made him a pillar for Alajuelense.",
    "legacyQuote": "A true fortress between the posts, Bolaños inspired confidence and stability every time he donned the gloves.",
    "rivalries": ["Saprissa"],
    "mentorOf": ["Emerging Costa Rican goalkeepers"],
    "inspiredBy": ["Legendary Central American keepers of the past"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/rafael-bolanos/profil/spieler/12345",
      "description": "Detailed career statistics and transfer history for Rafael Bolaños."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlights of Rafael Bolaños's outstanding saves during the 2004 season."
    }
  ]
}
```
