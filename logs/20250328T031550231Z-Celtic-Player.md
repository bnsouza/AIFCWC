...
- **Timestamp:** 2025-03-28T03:15:36.000Z
...
```json
{
  ...
  "history": {
    "fullName": "William Francis McNeill",
    "knownAs": "Billy McNeill",
    ...
    "honours": ["European Cup 1967", "Multiple Scottish League Titles", "Scottish Cup"],
    "individualAwards": ["Celtic FC Hall of Fame"],
    "nationalTeamCaps": 29,
    "styleOfPlay": "A composed and commanding central defender known for his exceptional leadership, tactical intelligence, and reliability in defense. His consistent performances and inspirational presence set the foundation for one of the greatest European Cup wins in 1967.",
    "legacyQuote": "Billy McNeill remains an icon not only for Celtic but for Scottish football as a whole, symbolizing bravery, tactical brilliance, and unwavering leadership on the pitch.",
    "rivalries": ["Rangers"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/billy-mcneill/profil/spieler/68967",
      "description": "Transfermarkt profile detailing Billy McNeill's career statistics and historical contributions."
    },
    {
      "url": "https://www.celticfc.com/history",
      "description": "Celtic FC official history page highlighting the club's legendary era and McNeill's influence in the 1967 European Cup triumph."
    }
  ]
}
```
