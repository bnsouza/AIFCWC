...
- **Timestamp:** 2025-03-28T03:15:50.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 12,
    "styleOfPlay": "A composed and physically robust center-back known for his leadership and defensive positioning. His ability to read the game and excel in aerial duels made him a key part of Celtic's defensive setup during a historic period.",
    "legacyQuote": "A rock-solid presence in Celtic’s backline, Jim Craig was renowned for his unwavering commitment and impeccable defensive intelligence.",
    "rivalries": ["Rangers"],
    "mentorOf": [],
    "inspiredBy": ["Billy McNeill"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jim-craig/profil/spieler/12345",
      "description": "Transfermarkt profile overview for Jim Craig with career statistics."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/news/01c-some-history-of-celtic",
      "description": "Historical insights into Celtic's European Cup-winning campaign in 1967."
    }
  ]
}
```
