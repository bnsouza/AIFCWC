...
- **Timestamp:** 2025-03-28T07:06:36.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 25,
    "styleOfPlay": "A creative central midfielder known for his incisive passing and exceptional vision, linking defense and attack with fluid control and timely interceptions.",
    "legacyQuote": "A midfield general whose timely passes often turned the tide of the game.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Xavi Hernandez", "Andres Iniesta"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com",
      "description": "Detailed career statistics and market value history."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlights compilation from the 2018 season at Al Sadd."
    },
    {
      "url": "https://www.uefa.com",
      "description": "UEFA articles featuring game analysis and tactical breakdowns."
    }
  ]
}
```
