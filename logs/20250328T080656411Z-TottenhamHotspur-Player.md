...
- **Timestamp:** 2025-03-28T08:06:44.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["UEFA Europa Conference League: Runner-up (2019)"],
    "individualAwards": ["Tottenham Hotspur Player of the Year (2018)"],
    "nationalTeamCaps": 26,
    "styleOfPlay": "An advanced playmaker known for his creativity, vision, and ability to exploit pockets of space between the opposition lines. In 2019, his performances highlighted his knack for incisive through passes and late runs into the box, making him a pivotal part of Tottenham's attacking setup.",
    "legacyQuote": "A player with a unique ability to unlock defenses with a single moment of brilliance.",
    "rivalries": ["Manchester United midfield battles"],
    "mentorOf": ["Young attacking midfielders at Spurs"],
    "inspiredBy": ["Frank Lampard", "Steven Gerrard"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/dele-alli/profil/spieler/225568",
      "description": "Transfermarkt profile for Dele Alli providing comprehensive career stats and history."
    },
    {
      "url": "https://www.premierleague.com/players/13265/Dele-Alli/overview",
      "description": "Premier League profile highlighting Dele Alli's performance and contributions."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Dele_Alli",
      "description": "Wikipedia page for Dele Alli, detailing his career, honours, and legacy."
    }
  ]
}
```
