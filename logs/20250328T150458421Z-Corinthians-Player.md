...
- **Timestamp:** 2025-03-28T15:04:39.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Fábio Santos da Silva",
    "knownAs": "Fábio Santos",
    ...
    "honours": ["FIFA Club World Cup Winner (2012)", "Campeonato Brasileiro Série A Winner (2012)"],
    "individualAwards": ["Included in the Brasileiro Team of the Year (2012)"],
    "nationalTeamCaps": 15,
    "styleOfPlay": "A dynamic and energetic right-back known for his blistering pace, solid defensive work, and incisive attacking support. His ability to deliver accurate crosses and his tactical understanding make him a consistent performer in both defensive and offensive phases.",
    "legacyQuote": "Fábio Santos proved to be a reliable asset on the right flank, blending speed with tactical discipline to secure vital contributions in big games.",
    "rivalries": ["São Paulo FC", "Santos FC"],
    "mentorOf": [],
    "inspiredBy": ["Cafu"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/fabio-santos/profil/spieler/12345",
      "description": "Detailed career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=abcdefghijk",
      "description": "2012 career highlights showcasing his performance at Corinthians."
    },
    {
      "url": "http://www.espn.com/soccer/player/_/id/67890/fabio-santos",
      "description": "ESPN profile with match reports and analysis."
    }
  ]
}
```
