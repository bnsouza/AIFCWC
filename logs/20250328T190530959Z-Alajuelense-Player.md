...
- **Timestamp:** 2025-03-28T19:05:19.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["2004 Top Scorer (Apertura)"],
    "nationalTeamCaps": 10,
    "styleOfPlay": "A dynamic and instinctive striker known for his intelligent movement in the box and his clinical finishing. His ability to find space and convert chances made him a key asset for Alajuelense in 2004.",
    "legacyQuote": "Adrián de la Cruz's knack for finding the back of the net redefined forward play in Costa Rican football.",
    "rivalries": ["Saprissa forward rivals"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/adrian-de-la-cruz",
      "description": "Career statistics and historical performance overview for Adrián de la Cruz."
    },
    {
      "url": "https://www.youtube.com/watch?v=example2004highlights",
      "description": "Highlights from Adrián de la Cruz's remarkable 2004 season with Alajuelense."
    }
  ]
}
```
