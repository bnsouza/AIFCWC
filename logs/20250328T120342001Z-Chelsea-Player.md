...
- **Timestamp:** 2025-03-28T12:03:28.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["PFA Team of the Year", "Chelsea Player of the Year"],
    "nationalTeamCaps": 78,
    "styleOfPlay": "A commanding center back known for his robust defending, excellent aerial ability, and unrivalled leadership on the pitch. In 2012, Terry was at his peak, organizing the backline and making crucial interventions.",
    "legacyQuote": "A true leader, both on and off the pitch, who epitomized defensive excellence.",
    "rivalries": ["Manchester United attackers", "Competitive on-field battles with opposing centre-backs"],
    "mentorOf": ["Gary Cahill", "Emerging young defenders at Chelsea"],
    "inspiredBy": ["Franz Beckenbauer", "Paolo Maldini"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/john-terry/profil/spieler/1884",
      "description": "John Terry's detailed profile and career statistics on Transfermarkt."
    },
    {
      "url": "https://www.chelseafc.com/en/teams/first-team/john-terry",
      "description": "Official profile of John Terry on Chelsea FC's website."
    },
    {
      "url": "https://www.premierleague.com/players/93/John-Terry/overview",
      "description": "John Terry's overview and achievements on the Premier League website."
    }
  ]
}
```
