...
- **Timestamp:** 2025-03-28T16:04:57.000Z
...
```json
{
  ...
  "history": {
    ...
    "nationalTeamCaps": 75,
    "styleOfPlay": "A calm and composed goalkeeper with exceptional reflexes and command of the penalty area, known for his consistency and leadership.",
    "legacyQuote": "A reliable last line of defense, whose longevity and brilliance set the benchmark for future generations.",
    "rivalries": ["Ray Clemence"],
    "mentorOf": ["Emerging young goalkeepers"],
    "inspiredBy": ["Lev Yashin"]
  },
  "links": [
    {
      "url": "https://en.wikipedia.org/wiki/Peter_Shilton",
      "description": "Detailed biography and career highlights of Peter Shilton."
    },
    {
      "url": "https://www.transfermarkt.com/peter-shilton/profil/spieler/95693",
      "description": "Career statistics and transfer history for Peter Shilton."
    }
  ]
}
```
