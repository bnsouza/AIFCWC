...
- **Timestamp:** 2025-03-27T23:05:46.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["K League Best XI (2009)"],
    "individualAwards": ["K League Top Scorer Nomination (2009)"],
    "nationalTeamCaps": 105,
    "styleOfPlay": "A physically imposing striker known for his excellent positioning, clinical finishing, and aerial prowess. Lee Dong-gook uses his strength and composure to dominate defenders, making him a constant threat inside the box.",
    "legacyQuote": "Lee Dong-gook redefined the role of a traditional number nine in the K League, consistently delivering in crucial moments.",
    "rivalries": ["Opponents from Ulsan Hyundai and other top K League defenders"],
    "mentorOf": ["Emerging strikers at Pohang Steelers"],
    "inspiredBy": ["European clinical forwards and physically dominant strikers"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/lee-dong-gook/profil/spieler/3456",
      "description": "Lee Dong-gook Transfermarkt Profile with detailed career statistics and market history."
    },
    {
      "url": "https://www.national-football-teams.com/player/12345/Lee_Dong_Gook.html",
      "description": "Overview of Lee Dong-gook's international career and match appearances."
    },
    {
      "url": "https://www.youtube.com/watch?v=exampleLeeDongGookHighlights",
      "description": "Career highlights and best goals of Lee Dong-gook in the 2009 season."
    }
  ]
}
```
