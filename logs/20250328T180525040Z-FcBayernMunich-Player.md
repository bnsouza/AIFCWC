...
- **Timestamp:** 2025-03-28T18:05:10.000Z
...
```json
{
  ...
  "attributes": {
    ...
    "specialSkill": "FootballIQ"
  },
  "history": {
    "fullName": "Thomas Müller",
    "knownAs": "Thomas Müller",
    ...
    "honours": ["Bundesliga Champion (2012–13)", "DFB-Pokal Winner (2012–13)"],
    "individualAwards": ["Bundesliga Team of the Season"],
    "nationalTeamCaps": 30,
    "styleOfPlay": "A versatile midfielder known for his exceptional spatial awareness, intelligent positioning, and ability to unlock defenses with incisive passing. Müller combines technical skill with a natural instinct for reading the game, making him a pivotal part of Bayern's midfield in 2013.",
    "legacyQuote": "A player whose game intelligence redefined midfield roles, turning space into opportunity.",
    "rivalries": ["Competing midfield talents in the Bundesliga and European competitions"],
    "mentorOf": [],
    "inspiredBy": ["Franz Beckenbauer", "Lothar Matthäus"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/thomas-mueller/profil/spieler/11115",
      "description": "Thomas Müller's Transfermarkt profile with career stats and historical performance."
    },
    {
      "url": "https://fcbayern.com/en/teams/first-team/thomas-mueller",
      "description": "Official FC Bayern Munich page for Thomas Müller highlighting his contributions."
    }
  ]
}
```
