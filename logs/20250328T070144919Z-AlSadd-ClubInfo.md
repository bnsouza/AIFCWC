## AI Generation Log: AlSadd-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-28T07:01:43.000Z
...
```
Provide the following details for the football club named Al Sadd (Qatar - AFC):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/alsaddsc",
    "tiktok": "https://www.tiktok.com/@alsaddsc"
  },
  "colors": {
    "home": {
