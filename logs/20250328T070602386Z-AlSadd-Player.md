...
- **Timestamp:** 2025-03-28T07:05:45.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Qatari Best Young Player (2018)"],
    "nationalTeamCaps": 18,
    "styleOfPlay": "A skillful left winger known for his breathtaking dribbles, incisive pace, and ability to cut inside to create scoring opportunities. His flair on the ball and creativity make him a constant threat on the left flank.",
    "legacyQuote": "A magician on the left flank who turns games on their head with his mesmerizing dribbles and visionary play.",
    "rivalries": ["Top domestic defenders"],
    "mentorOf": [],
    "inspiredBy": ["Ronaldinho", "Mohamed Salah"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/mohamed-afif/profil/spieler/xxxx",
      "description": "Transfermarkt profile of Mohamed Afif"
    },
    {
      "url": "https://www.youtube.com/watch?v=xxxx",
      "description": "Highlights of Mohamed Afif's performance in 2018"
    },
    {
      "url": "https://www.qsl.qa",
      "description": "Qatar Stars League official website"
    }
  ]
}
```
