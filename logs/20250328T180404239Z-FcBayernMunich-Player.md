...
- **Timestamp:** 2025-03-28T18:03:35.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Bundesliga Champion (2010, 2013)", "DFB-Pokal Winner (2010)"],
    "individualAwards": [],
    "nationalTeamCaps": 38,
    "styleOfPlay": "Dante is a rock-solid and composed center back renowned for his intelligent positioning, aerial dominance, and leadership. His tactical understanding and reliability allowed him to marshal Bayern Munich's defense with authority during the 2013 season.",
    "legacyQuote": "A rock in the defense, Dante symbolized consistency, professionalism, and fearless leadership.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Franz Beckenbauer", "Bobby Moore"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/dante/profil/spieler/2101",
      "description": "Transfermarkt profile of Dante featuring detailed career statistics."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/clubs/50037--bayern-munich/",
      "description": "UEFA overview of Bayern Munich's squad and historical achievements during Dante's tenure."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Compilation of Dante's defensive highlights and key moments."
    }
  ]
}
```
