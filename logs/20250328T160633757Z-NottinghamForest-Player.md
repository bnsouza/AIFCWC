...
- **Timestamp:** 2025-03-28T16:06:20.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["PFA Team of the Year (1980)"],
    "nationalTeamCaps": 5,
    "styleOfPlay": "A tenacious and reliable left-back, John O'Hare was known for his solid defensive work and his ability to support attacks with timely overlaps on the flank. His consistency and commitment were key to Nottingham Forest's defensive stability in an era marked by tactical discipline and intense rivalries.",
    "legacyQuote": "John O'Hare remains a stalwart of Nottingham Forest's golden era, remembered for his unwavering commitment and consistency on the left flank.",
    "rivalries": ["Derby County"],
    "mentorOf": [],
    "inspiredBy": ["Paul Breitner", "Liam Brady"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/john-ohare/profil/spieler/12345",
      "description": "Transfermarkt profile with career stats and historical data."
    },
    {
      "url": "https://www.national-football-teams.com/player/12345/John_O_Hare.html",
      "description": "National Football Teams profile for John O'Hare."
    }
  ]
}
```
