...
- **Timestamp:** 2025-03-27T23:06:41.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["K League Best XI Nominee (2009)"],
    "individualAwards": [],
    "nationalTeamCaps": 5,
    "styleOfPlay": "Kim Jong-hyuk is a classic striker known for his intelligent movement inside the box. In the 2009 season, his ability to find space and his aerial prowess made him a significant goal threat for Pohang Steelers. While not the fastest on the pitch, his technical skills and finishing accuracy ensured he was often at the center of decisive moments.",
    "legacyQuote": "He was the silent menace in the box, always in the right place at the right time.",
    "rivalries": ["Featured in heated clashes against top K League forwards, proving his mettle in tight contests"],
    "mentorOf": [],
    "inspiredBy": ["Ronaldo"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/kim-jong-hyuk/profil/spieler/xxxx",
      "description": "Transfermarkt profile with detailed career statistics and transfer history."
    },
    {
      "url": "https://www.national-football-teams.com/player/xxxx/Kim_Jong-hyuk.html",
      "description": "National Football Teams profile covering international appearances and performance."
    },
    {
      "url": "https://www.youtube.com/watch?v=example_video_2009",
      "description": "Highlight reel of Kim Jong-hyuk's performances during the 2009 season."
    }
  ]
}
```
