## AI Generation Log: Santos-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-27T08:10:06.000Z
...
```
Provide the following details for the football club named Santos (Brazil - CONMEBOL):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/santosfc",
    "tiktok": "https://www.tiktok.com/@santosfc"
  },
  "colors": {
    "home": {
