...
- **Timestamp:** 2025-03-28T04:02:53.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Ligue 1 Champion (2020)", "Coupe de France Winner (2020)", "Trophée des Champions Winner (2020)"],
    "individualAwards": [],
    "nationalTeamCaps": 18,
    "styleOfPlay": "A dynamic and attacking fullback renowned for his explosive pace and precise crossing. Bernat is known for his overlapping runs, solid defensive contributions, and ability to support the attack from the right flank.",
    "legacyQuote": "Bernat's overlapping runs and pinpoint crosses have redefined the modern fullback role at PSG, blending traditional defensive duties with an attacking mindset.",
    "rivalries": [],
    "mentorOf": [],
  ...
  "links": [
    {
      "url": "https://www.transfermarkt.com/juan-bernat/profil/spieler/81768",
      "description": "Detailed career statistics and profile on Transfermarkt."
    },
    {
      "url": "https://www.psg.fr/en/teams/first-team/content/juan-bernat",
      "description": "Official PSG profile for Juan Bernat."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Compilation of career highlights and key moments from Juan Bernat."
    }
  ]
}
```
