...
- **Timestamp:** 2025-03-28T02:30:45.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Egypt Cup: 2016", "Egyptian Super Cup: Runner-up 2016"],
    "individualAwards": ["Egyptian League Best Left Back 2016"],
    "nationalTeamCaps": 15,
    "styleOfPlay": "A traditional left back known for his reliability in defense, overlapping runs, and accurate crosses. In 2016, his performances were characterized by disciplined defending and timely support in attacks.",
    "legacyQuote": "Ahmed Samy will be remembered for his relentless work rate and tactical intelligence on the left flank, earning a reputation as one of the dependably solid defenders of his generation.",
    "rivalries": ["Al Ahly"],
    "mentorOf": [],
    "inspiredBy": ["Egyptian defensive legends", "Local Zamalek veterans"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/ahmed-samy/profil/spieler/xxxx",
      "description": "Detailed career statistics and market value information for Ahmed Samy on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=example_highlights",
      "description": "Highlight reel of Ahmed Samy's standout performances in 2016."
    },
    {
      "url": "https://www.footballdatabase.eu/en/player/details/xxxx",
      "description": "Comprehensive profile including match stats and analysis during his tenure at Zamalek."
    }
  ]
}
```
