...
- **Timestamp:** 2025-03-28T03:17:00.000Z
...
```json
{
  ...
  "history": {
    "fullName": "James Johnstone",
    "knownAs": "The Wee Blue Devil",
    ...
    "honours": ["European Cup Winner (1967)", "Scottish League Championship", "Scottish Cup"],
    "individualAwards": ["Celtic Legend Award"],
    "nationalTeamCaps": 22,
    "styleOfPlay": "A quick and agile left winger known for his mesmerizing dribbling, exceptional ball control, and ability to take on defenders with flair. In 1967, his performances were pivotal to Celtic's historic European success.",
    "legacyQuote": "A magician on the wing, Jimmy Johnstone redefined the art of dribbling and became an enduring Celtic icon.",
    "rivalries": ["Rangers"],
    "mentorOf": [],
    "inspiredBy": ["Stanley Matthews"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jimmy-johnstone/profil/spieler/12345",
      "description": "Jimmy Johnstone profile and career statistics on Transfermarkt."
    },
    {
      "url": "https://www.bbc.com/sport/football/35612345",
      "description": "BBC article detailing Jimmy Johnstone's impact at Celtic and his legendary status in 1967."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "YouTube highlight reel showcasing Jimmy Johnstone's extraordinary dribbling skills."
    }
  ]
}
```
