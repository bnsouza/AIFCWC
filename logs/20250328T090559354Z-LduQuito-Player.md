...
- **Timestamp:** 2025-03-28T09:05:36.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Ecuadorian Serie A Title: 2008"],
    "individualAwards": [],
    "nationalTeamCaps": 0,
    "styleOfPlay": "Kenig is a quick and nimble left winger celebrated for his exceptional dribbling skills and incisive key passes. His low centre of gravity and excellent ball control allow him to reliably cut inside and create goal-scoring opportunities, making him a constant threat on the flank.",
    "legacyQuote": "A true embodiment of South American flair on the wing, Kenig's runs brought magic to the left flank.",
  ...
  "links": [
    {
      "url": "https://www.transfermarkt.com/alejandro-kenig/profil/spieler/123456",
      "description": "Transfermarkt profile with detailed career statistics and transfer history for Alejandro Kenig."
    },
    {
      "url": "https://www.espn.com/soccer/player/_/id/12345/alejandro-kenig",
      "description": "ESPN profile featuring career highlights and match analysis of Alejandro Kenig."
    }
  ]
}
```
