...
- **Timestamp:** 2025-03-28T08:04:21.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Toby Albertine Alderweireld",
    "knownAs": "Toby Alderweireld",
    ...
    "honours": ["Eredivisie: 2010-11", "KNVB Cup: 2009-10"],
    "individualAwards": [],
    "nationalTeamCaps": 81,
    "styleOfPlay": "A composed and tactically intelligent centre-back known for his excellent defensive positioning, precise passing, and ability to read the game. In 2019, his experience and leadership were key to Tottenham's defensive organization.",
    "legacyQuote": "Alderweireld redefined modern defending with a blend of elegance, intelligence, and uncompromising toughness.",
    "rivalries": ["Consistently matched up against top attacking talents across the Premier League"],
    "mentorOf": [],
    "inspiredBy": ["Franz Beckenbauer", "Carles Puyol"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/toby-alderweireld/profil/spieler/9351",
      "description": "Detailed career stats and historical performance data for Toby Alderweireld."
    },
    {
      "url": "https://www.tottenhamhotspur.com",
      "description": "Official website of Tottenham Hotspur, featuring news and match reports from the 2019 season."
    },
    {
      "url": "https://www.uefa.com/uefaeuropaleague/history/season=2019/",
      "description": "UEFA's archive of the 2019 season, providing context on European competitions in which Alderweireld participated."
    }
  ]
}
```
