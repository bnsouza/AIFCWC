...
- **Timestamp:** 2025-03-28T04:06:56.000Z
...
```json
{
  ...
  "history": {
    ...
    "career": [
      ...
      {
        "club": "Other Clubs (Earlier Career)",
        "from": 2010,
        "to": 2019,
        "appearances": 210,
        "goals": 35,
    ...
    "honours": ["Ligue 1 Champion", "Coupe de France Winner", "Trophée des Champions"],
    "individualAwards": [],
    "nationalTeamCaps": 12,
    "styleOfPlay": "A creative playmaker with excellent technical ability and vision. Sarabia is known for his dribbling, accurate through passes, and effective long-range shooting. He plays a key role in unlocking defenses and is a creative force in the final third.",
    "legacyQuote": "A player who brings flair and intelligence to the attacking midfield role, embodying the modern playmaker's spirit.",
    "rivalries": ["Rivalries with top European clubs' defensive setups, notably those of Barcelona and Real Madrid."],
    "mentorOf": ["Emerging talents in the attacking midfield role at PSG"],
    "inspiredBy": ["Juan Mata", "Andrés Iniesta"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/pablo-sarabia/profil/spieler/12345",
      "description": "Transfermarkt profile with detailed statistics and career history."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/clubs/players/1907547--pablo-sarabia/",
      "description": "UEFA profile and highlights from European competitions."
    },
    {
      "url": "https://www.youtube.com/watch?v=EXAMPLE_Sarabia2020",
      "description": "Video highlights of Pablo Sarabia during his PSG tenure in 2020."
    }
  ]
}
```
