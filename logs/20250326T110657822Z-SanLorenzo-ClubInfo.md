...
```
Provide the following details for the football club named San Lorenzo (Argentina - CONMEBOL):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/sanlorenzo",
    "tiktok": "https://www.tiktok.com/@sanlorenzo"
  },
  "colors": {
    "home": {
