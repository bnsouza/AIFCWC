...
- **Timestamp:** 2025-03-28T02:29:53.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Egypt Cup (2015)", "Egypt Super Cup (2016)"],
    "individualAwards": [],
    "nationalTeamCaps": 20,
    "styleOfPlay": "A versatile and reliable right back known for his strong defensive positioning, robust marking, and ability to support attacks with timely overlaps. His disciplined tackling and clearances often help set the defensive tone, while his decent pace enables him to recover quickly and contribute to counter-attacks.",
    "legacyQuote": "A reliable and hardworking player who embodies the fighting spirit of Zamalek both on and off the pitch.",
    "rivalries": ["Al Ahly"],
    "mentorOf": [],
    "inspiredBy": ["Franz Beckenbauer", "Cafu"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/ahmed-hegazi/profil/spieler/110003",
      "description": "Transfermarkt profile for Ahmed Hegazi with detailed career statistics."
    },
    {
      "url": "https://www.youtube.com/watch?v=x_example",
      "description": "Highlight reel showcasing his performances with Zamalek during the 2016 season."
    }
  ]
}
```
