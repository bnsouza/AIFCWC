...
- **Timestamp:** 2025-03-28T18:07:09.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Bundesliga: 2012–13", "DFB-Pokal: 2012–13"],
    "individualAwards": [],
    "nationalTeamCaps": 0,
    "styleOfPlay": "Tom Starke is a reliable shot-stopper known for his solid positioning, composure, and effective command of his penalty area. He may not be the flashiest keeper, but his consistent performances and ability to organize his defense made him a dependable asset during his time at Bayern Munich.",
    "legacyQuote": "A reliable safeguard for Bayern, Tom Starke exemplified consistency and professionalism during his tenure.",
    "rivalries": [],
    "mentorOf": [],
  ...
  "links": [
    {
      "url": "https://en.wikipedia.org/wiki/Tom_Starke",
      "description": "Tom Starke's Wikipedia page with career overview and statistics."
    },
    {
      "url": "https://www.transfermarkt.com/tom-starke/profil/spieler/2211",
      "description": "Detailed career statistics and historical performance data on Transfermarkt."
    },
    {
      "url": "https://fcbayern.com/en/teams/profiles/tom-starke",
      "description": "FC Bayern Munich profile highlighting Tom Starke's contributions during his tenure."
    }
  ]
}
```
