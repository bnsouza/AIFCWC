...
- **Timestamp:** 2025-03-28T18:07:32.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Bundesliga Champion", "DFB-Pokal Winner"],
    "individualAwards": ["Swiss Footballer of the Year"],
    "nationalTeamCaps": 35,
    "styleOfPlay": "A dynamic and agile right winger known for his explosive pace, exceptional dribbling and creativity, Shaqiri is capable of breaking down defenses with his incisive key passes and quick feet. His ability to cut inside and take shots from distance makes him an unpredictable attacking threat.",
    "legacyQuote": "A magician on the flank, Shaqiri combines pace with precision, consistently turning tight spaces into goal-scoring opportunities.",
    "rivalries": [],
    "mentorOf": [],
  ...
  "links": [
    {
      "url": "https://www.transfermarkt.com/xherdan-shaqiri/profil/spieler/104117",
      "description": "Detailed career statistics and transfer history for Xherdan Shaqiri on Transfermarkt."
    },
    {
      "url": "https://www.fifa.com/fifa-tournaments/players-coaches/people=284048/index.html",
      "description": "FIFA profile of Xherdan Shaqiri with career highlights and tournament performances."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Xherdan_Shaqiri",
      "description": "Comprehensive Wikipedia article detailing Shaqiri's career, honours, and biography."
    }
  ]
}
```
