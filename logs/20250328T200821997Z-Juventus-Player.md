...
- **Timestamp:** 2025-03-28T20:07:56.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Serie A: 1996–97", "Coppa Italia: 1998–99"],
    "individualAwards": [],
    "nationalTeamCaps": 63,
    "styleOfPlay": "A left-footed centre-back renowned for his exceptional free-kick technique and tactical intelligence. Mihajlović combined robust defensive skills with an ability to deliver dangerous set-pieces, making him a unique asset in both defensive and offensive roles.",
    "legacyQuote": "A defender whose free-kick mastery redefined set-piece excellence.",
    "rivalries": ["AC Milan attacking lineups"],
    "mentorOf": ["Andrea Barzagli", "Giorgio Chiellini"],
    "inspiredBy": ["Franz Beckenbauer"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/sinisa-mihajlovic/profil/spieler/2760",
      "description": "Transfermarkt profile of Siniša Mihajlović with detailed statistics and career history."
    },
    {
      "url": "https://www.uefa.com/insideuefa/news/01d6-0f847d1d7e18-7afc46ec6d4b-1000--mihajlovic-the-free-kick-master/",
      "description": "UEFA article highlighting Mihajlović's free kick mastery and his impact on the game."
    }
  ]
}
```
