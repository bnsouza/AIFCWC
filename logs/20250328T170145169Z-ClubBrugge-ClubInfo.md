## AI Generation Log: ClubBrugge-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-28T17:01:42.000Z
...
```
Provide the following details for the football club named Club Brugge (Belgium - UEFA):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/clubbrugge",
    "tiktok": "https://www.tiktok.com/@clubbrugge"
  },
  "colors": {
    "home": {
      "bgColor": "rgb(0, 0, 102)",
