...
- **Timestamp:** 2025-03-28T10:01:45.000Z
...
```
Provide the following details for the football club named Comunicaciones (Guatemala - CONCACAF):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/cremasoficial/",
    "tiktok": "https://www.tiktok.com/@cremasoficial"
  },
  "colors": {
    "home": {
