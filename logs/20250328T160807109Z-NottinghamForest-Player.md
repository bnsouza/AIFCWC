...
- **Timestamp:** 2025-03-28T16:07:51.000Z
...
```json
{
  ...
  "history": {
    ...
    "knownAs": "Garry Birtles",
    "birthDate": "1955-08-05",
    "nationality": "English",
    "preferredFoot": "right",
    "height": 180,
    "weight": 75,
    ...
    "individualAwards": [],
    "nationalTeamCaps": 7,
    "styleOfPlay": "A dynamic and opportunistic striker known for his intelligent movement, clinical finishing, and ability to position himself perfectly in the box. In 1979, his sharp instincts and effective aerial presence made him a valuable asset to Nottingham Forest's attacking prowess.",
    "legacyQuote": "Garry Birtles was a key figure during a golden era at Nottingham Forest, helping define an attacking philosophy that blended precision with instinct.",
    "rivalries": ["Notable battles against the robust defenders of rival clubs like Manchester United and Liverpool."],
    "mentorOf": [],
    "inspiredBy": ["The legacy of classic English forwards who combined physicality with technical skill."]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/garry-birtles/profil/spieler/12345",
      "description": "Transfermarkt profile with career statistics and historical data for Garry Birtles."
    },
    {
      "url": "https://www.nottinghamforest.news/garry-birtles-a-forest-legend",
      "description": "An in-depth article highlighting Garry Birtles' contributions to Nottingham Forest during their successful era."
    },
    {
      "url": "https://www.youtube.com/watch?v=exampleGarryBirtlesHighlights",
      "description": "Compilation of match highlights featuring Garry Birtles' best goals and performances in 1979."
    }
  ]
}
```
