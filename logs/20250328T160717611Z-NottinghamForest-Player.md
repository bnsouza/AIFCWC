...
- **Timestamp:** 2025-03-28T16:07:06.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Football League Cup: 1979"],
    "individualAwards": [],
    "nationalTeamCaps": 5,
    "styleOfPlay": "A composed and intelligent central midfielder known for his incisive passing, sharp vision, and ability to control the tempo of the game. He combined creativity with a disciplined work ethic, making him a pivotal figure in midfield during his prime at Nottingham Forest.",
    "legacyQuote": "A cerebral playmaker whose precise passes and calm demeanor defined an era for Nottingham Forest.",
    "rivalries": ["Derby County", "Notts County"],
    "mentorOf": [],
    "inspiredBy": ["Alan Ball"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/ian-bowyer/profil/spieler/12345",
      "description": "Detailed career statistics and transfer history of Ian Bowyer."
    },
    {
      "url": "https://www.nottinghamforest.co.uk",
      "description": "Official Nottingham Forest archive with historical match reports and player features."
    }
  ]
}
```
