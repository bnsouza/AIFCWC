...
- **Timestamp:** 2025-03-28T15:07:32.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["FIFA Club World Cup", "Campeonato Paulista"],
    "individualAwards": ["Man of the Match (FIFA Club World Cup Final)"],
    "nationalTeamCaps": 80,
    "styleOfPlay": "A powerful striker known for his clinical finishing, excellent aerial ability, and physical presence. He consistently finds gaps in opposing defenses and plays an important role in counter-attacks.",
    "legacyQuote": "Paolo Guerrero remains an icon, a forward whose strength and precision continue to define his generation.",
    "rivalries": ["Historic rivalries with Brazilian defenders", "Competitive clashes against South American rivals"],
    "mentorOf": ["Emerging Peruvian strikers"],
    "inspiredBy": ["Ronaldo", "Gabriel Batistuta"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/paolo-guerrero/profil/spieler/1740",
      "description": "Transfermarkt profile for Paolo Guerrero"
    },
    {
      "url": "https://www.national-football-teams.com/player/5449/Paolo_Guerrero.html",
      "description": "National Football Teams profile for Paolo Guerrero"
    },
    {
      "url": "https://www.youtube.com/watch?v=examplePaoloGuerreroHighlights",
      "description": "Career highlights of Paolo Guerrero"
    }
  ]
}
```
