...
- **Timestamp:** 2025-03-28T12:04:14.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Premier League Title", "FA Cup", "League Cup", "UEFA Champions League (2012)", "Community Shield"],
    "individualAwards": ["Chelsea Player of the Year", "Premier League Team of the Year"],
    "nationalTeamCaps": 106,
    "styleOfPlay": "A highly intelligent central midfielder known for his impeccable timing in making late runs into the box, exceptional passing range, and a knack for scoring crucial goals. Lampard combined a strong work ethic with technical proficiency and tactical versatility.",
    "legacyQuote": "Lampard is remembered as one of Chelsea's all-time greatest midfielders, whose goal-scoring prowess and visionary play revolutionized the midfield role.",
    "rivalries": ["Arsenal", "Manchester United"],
    "mentorOf": ["Younger Chelsea talents"],
    "inspiredBy": ["Frank Lampard Sr."]
  },
  "links": [
    {
    ...
    },
    {
      ...
      "description": "Official Chelsea FC website featuring Lampard's legacy and career highlights."
    },
    {
      "url": "https://www.transfermarkt.com/frank-lampard/profil/spieler/3224",
      "description": "Statistical profile and historical performance data on Transfermarkt."
    }
  ]
}
```
