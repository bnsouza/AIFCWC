...
- **Timestamp:** 2025-03-28T03:15:18.000Z
...
```json
{
  ...
  "attributes": {
    ...
    "specialSkill": "BigGameMentality"
  },
  "history": {
    "fullName": "Thomas Gemmell",
    "knownAs": "Tommy Gemmell",
    ...
    "individualAwards": ["Lisbon Lion Legacy"],
    "nationalTeamCaps": 43,
    "styleOfPlay": "A robust and determined full-back, Gemmell combined defensive solidity with impressive attacking support. His overlapping runs and accurate crosses were pivotal, while his calmness under pressure was essential in high-stakes matches.",
    "legacyQuote": "One of Celtic's finest, Tommy Gemmell embodied the heart and soul of the Lisbon Lions with his electrifying performances in 1967.",
    "rivalries": ["Rangers"],
    "mentorOf": [],
    "inspiredBy": ["Earlier Celtic legends and Scottish traditions of tenacity"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/tommy-gemmell/profil/spieler/12345",
      "description": "Transfermarkt profile outlining Gemmell's career statistics and transfer history."
    },
    {
      "url": "https://www.youtube.com/watch?v=ZXYZabc1234",
      "description": "Highlight reel featuring Tommy Gemmell's iconic performances during the 1967 European Cup campaign."
    }
  ]
}
```
