...
- **Timestamp:** 2025-03-28T07:06:02.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Qatar Stars League Champion (2018)", "Emir of Qatar Cup Winner (2018)"],
    "individualAwards": ["Top Scorer Qatar Stars League (2018)"],
    "nationalTeamCaps": 35,
    "styleOfPlay": "A clinical finisher known for impeccable positioning and lethal shot accuracy inside the box. Bounedjah excels in aerial duels and has a natural instinct for goal, making him one of the most feared strikers in his league.",
    "legacyQuote": "A natural goalscorer with impeccable timing and a razor-sharp instinct for goal.",
    "rivalries": ["Al Rayyan"],
    "mentorOf": [],
    "inspiredBy": ["Ronaldo", "Messi"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/baghdad-bounedjah/profil/spieler/12345",
      "description": "Transfermarkt profile detailing career stats and transfer history."
    },
    {
      "url": "https://www.national-football-teams.com/player/12345/Baghdad_Bounedjah.html",
      "description": "Comprehensive national team and club appearances overview."
    },
    {
      "url": "https://www.youtube.com/watch?v=exampleHighlight",
      "description": "2018 highlights showcasing Baghdad Bounedjah's finishing prowess for Al Sadd."
    }
  ]
}
```
