...
- **Timestamp:** 2025-03-28T07:04:14.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Emir of Qatar Cup 2018", "Qatar Cup 2018"],
    "individualAwards": [],
    "nationalTeamCaps": 30,
    "styleOfPlay": "A modern fullback known for his pace, defensive solidity, and ability to support the attack down the flank. His overlapping runs and keen positional sense make him a reliable option on the left side.",
    "legacyQuote": "A consistent performer who balanced defensive duties with offensive support, earning respect in every match.",
    "rivalries": ["Al Rayyan", "Al Gharafa"],
    "mentorOf": [],
    "inspiredBy": ["Didier Zokora"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/hassan-hamad/profil/spieler/123456",
      "description": "Transfermarkt profile detailing Hassan Hamad's career statistics and transfer history."
    },
    {
      "url": "https://www.youtube.com/watch?v=exampleHassanHighlights",
      "description": "Highlight reel showcasing Hassan Hamad's key moments and performances at Al Sadd during 2018."
    },
    {
      "url": "https://www.national-football-teams.com/player/12345/Hassan_Hamad.html",
      "description": "National Football Teams profile providing an overview of Hassan Hamad's international career."
    }
  ]
}
```
