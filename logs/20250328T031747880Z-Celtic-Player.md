...
- **Timestamp:** 2025-03-28T03:17:32.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["European Cup 1967", "Scottish League Championship", "Scottish Cup"],
    "individualAwards": ["Lisbon Lion"],
    "nationalTeamCaps": 22,
    "styleOfPlay": "A dynamic attacking midfielder known for his brilliant dribbling, incisive through passes, and eye for long-range strikes. Wallace combined flair with tactical discipline, playing a pivotal role in unlocking opposition defenses.",
    "legacyQuote": "Willie Wallace embodied the spirit of Celtic in 1967, with his dazzling runs and incisive play paving the way for one of football's most memorable triumphs.",
    "rivalries": ["Rangers"],
    "mentorOf": ["Emerging Celtic talents of the late 1960s and early 1970s"],
    "inspiredBy": ["Billy McNeill", "Jock Stein"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/willie-wallace/profil/spieler/12345",
      "description": "Transfermarkt profile with career statistics and historical data."
    },
    {
      "url": "https://www.youtube.com/watch?v=lisbonlionshighlights",
      "description": "Video highlights of Celtic's 1967 European Cup-winning campaign featuring Wallace."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/news/01/",
      "description": "UEFA article detailing the historic achievements of Celtic's Lisbon Lions."
    }
  ]
}
```
