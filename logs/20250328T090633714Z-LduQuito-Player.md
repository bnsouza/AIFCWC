...
- **Timestamp:** 2025-03-28T09:06:16.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Golden Glove Award 2008"],
    "nationalTeamCaps": 10,
    "styleOfPlay": "A commanding presence between the sticks, Sánchez combined sharp reflexes with strong leadership. His ability to read the game and make crucial one-on-one interventions made him indispensable during high-pressure matches in LDU Quito's historic 2008 campaign.",
    "legacyQuote": "A reliable last line of defense, Sánchez set the standard for Ecuadorian goalkeeping in his era.",
    "rivalries": ["Rival South American goalkeepers in continental competitions"],
    "mentorOf": ["Younger goalkeeping talents emerging in Ecuador"],
    "inspiredBy": ["René Higuita"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jose-luis-sanchez/profil/spieler/12345",
    ...
    },
    {
      ...
      "description": "Compilation of José Luis Sánchez's key saves and highlights from the 2008 season."
    }
  ]
}
```
