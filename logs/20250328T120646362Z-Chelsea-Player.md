...
- **Timestamp:** 2025-03-28T12:06:31.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Jeffrey Ronald Bruma",
    "knownAs": "Jeffrey Bruma",
    ...
    "honours": ["UEFA Champions League Winner (2012)", "FA Cup Winner (2012)"],
    "individualAwards": [],
    "nationalTeamCaps": 10,
    "styleOfPlay": "A solid and composed center-back known for his physical presence and reliable marking. Bruma is effective in aerial duels and combines a disciplined defensive approach with the ability to contribute to build-up play.",
    "legacyQuote": "A promising defensive talent at Chelsea, Jeffrey Bruma bridged raw physicality with emerging technical skills to hold his own in one of the world's toughest leagues.",
    "rivalries": ["Competing with top Premier League defenders for recognition"],
    "mentorOf": [],
    "inspiredBy": ["Former Dutch defenders and Italian defensive tacticians"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jeffrey-bruma/profil/spieler/11730",
      "description": "Transfermarkt profile with detailed career stats."
    },
    {
      "url": "https://www.chelseafc.com/en/teams/first-team/jeffrey-bruma",
      "description": "Archived Chelsea FC profile highlighting his contributions during his time at the club."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Jeffrey_Bruma",
      "description": "Wikipedia article with comprehensive information on his career and achievements."
    }
  ]
}
```
