...
- **Timestamp:** 2025-03-28T19:03:46.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Óscar Blanco",
    "knownAs": "Óscar Blanco",
    ...
    "honours": ["Liga FPD Championship 2004"],
    "individualAwards": [],
    "nationalTeamCaps": 25,
    "styleOfPlay": "A committed and disciplined left back known for his defensive solidity and ability to support the attack with overlapping runs and accurate crosses. In 2004, his work-rate and tactical awareness were pivotal in both defensive duties and initiating offensive plays.",
    "legacyQuote": "Óscar Blanco was a cornerstone at left-back, blending defensive reliability with offensive support, truly mesmerizing fans with his relentless work-rate.",
    "rivalries": ["Saprissa Clásico Battles"],
    "mentorOf": [],
    "inspiredBy": ["Cafu"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/oscar-blanco/profil/spieler/12345",
      "description": "Detailed career statistics and history for Óscar Blanco on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=example_highlights",
      "description": "Compilation of Óscar Blanco's performance highlights during his time with Alajuelense."
    },
    {
      "url": "https://www.espn.com/soccer/story/_/id/example_oscar_blanco_profile",
      "description": "ESPN profile article discussing Óscar Blanco's impact in Costa Rican football."
    }
  ]
}
```
