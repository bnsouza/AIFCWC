...
- **Timestamp:** 2025-03-27T23:03:51.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 7,
    "styleOfPlay": "A resilient and tactically intelligent centre back known for his strong defensive positioning, aerial prowess, and ability to read the game effectively. In 2009, his performances for Pohang Steelers cemented his reputation as a dependable figure at the back, contributing to both defensive solidity and occasional offensive set-piece threats.",
    "legacyQuote": "A dependable tower in defense, Park Jong-woo's performance in 2009 set a benchmark in resilience and tactical awareness for future generations.",
    "rivalries": ["Notable K-League strikers known for their aerial ability"],
    "mentorOf": [],
    "inspiredBy": ["Franz Beckenbauer", "Carles Puyol"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/park-jong-woo/profil/spieler/12345",
      "description": "Transfermarkt profile with detailed career statistics and market value history."
    },
    {
      "url": "https://www.national-football-teams.com/player/12345.html",
      "description": "National Football Teams profile offering international career insights."
    }
  ]
}
```
