...
- **Timestamp:** 2025-03-28T04:04:09.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Ligue 1 Champion (2019–20)", "Coupe de France Winner (2019–20)", "Trophée des Champions Winner"],
    "individualAwards": ["UNFP Ligue 1 Team of the Year (2020)"],
    "nationalTeamCaps": 40,
    "styleOfPlay": "A technically gifted deep-lying playmaker known for his exceptional ball control, vision, and passing ability, Verratti excels in tight spaces and orchestrates the game’s rhythm from midfield.",
    "legacyQuote": "Small in stature, giant in influence.",
    "rivalries": ["Opposing top midfield tacticians"],
    "mentorOf": ["Younger PSG midfield talents"],
    "inspiredBy": ["Andrea Pirlo", "Xavi Hernandez"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/marco-verratti/profil/spieler/183371",
      "description": "Transfermarkt profile of Marco Verratti with detailed statistics and market value information."
    },
    {
      "url": "https://en.psg.fr",
      "description": "Official PSG website where Marco Verratti's profile and latest news can be found."
    },
    {
      "url": "https://int.soccerway.com/players/marco-verratti/106977/",
      "description": "Soccerway statistical profile for Marco Verratti including match appearances, goals, and assists."
    }
  ]
}
```
