## AI Generation Log: BaFc-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-27T00:31:58.000Z
...
```
Provide the following details for the football club named Ba FC (Fiji - OFC):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/ba_fc",
    "tiktok": "https://www.tiktok.com/@ba_fc"
  },
  "colors": {
    "home": {
      "bgColor": "rgb(0, 0, 0)",
