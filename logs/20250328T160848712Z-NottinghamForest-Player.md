...
- **Timestamp:** 2025-03-28T16:08:37.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Football League Cup: 1978-79"],
    "individualAwards": [],
    "nationalTeamCaps": 5,
    "styleOfPlay": "A composed central midfielder known for his precise passing and game intelligence, Alan Hinton was instrumental in linking defense and attack. His excellent vision and disciplined play allowed him to control the tempo of the match and contribute significantly in both defensive and offensive phases.",
    "legacyQuote": "A player who embodied the spirit of Nottingham Forest with his unwavering work rate and intelligent playmaking.",
    "rivalries": ["Competitive clashes with top midfield opponents in the English league"],
    "mentorOf": [],
    "inspiredBy": ["Nobby Stiles", "Billy Wright"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/alan-hinton/profil/spieler/XXXXX",
      "description": "Detailed statistical profile and career history on Transfermarkt."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/news/newsid=XXXXX.html",
      "description": "Historical match highlights and interviews from Nottingham Forest's successful era."
    }
  ]
}
```
