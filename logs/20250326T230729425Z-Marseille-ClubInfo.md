## AI Generation Log: Marseille-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-26T23:07:26.000Z
...
```
Provide the following details for the football club named Marseille (France - UEFA):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/olympiquedemarseille",
    "tiktok": "https://www.tiktok.com/@olympiquedemarseille"
  },
  "colors": {
    "home": {
