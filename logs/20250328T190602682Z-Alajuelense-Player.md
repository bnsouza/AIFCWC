...
- **Timestamp:** 2025-03-28T19:05:45.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["CSD Best Defender Award 2004"],
    "nationalTeamCaps": 5,
    "styleOfPlay": "A solid and reliable central defender, Jorge Arias is known for his robust marking, exceptional aerial ability, and intelligent positional play. In 2004, his consistency and effective defending were key to Alajuelense's strong campaign, and he was often seen organizing the backline and neutralizing opposing forwards.",
    "legacyQuote": "A rock at the back, Jorge Arias defined Alajuelense's defensive solidity in the early 2000s.",
    "rivalries": ["Saprissa", "Herediano"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/jorge-arias",
      "description": "Transfermarkt profile detailing career statistics and historical data for Jorge Arias."
    },
    {
      "url": "https://www.national-football-teams.com/player/jorge-arias",
      "description": "National Football Teams profile with international career information for Jorge Arias."
    },
    {
      "url": "https://www.youtube.com/watch?v=example_highlights",
      "description": "Video highlights of Jorge Arias during the 2004 season with Alajuelense."
    }
  ]
}
```
