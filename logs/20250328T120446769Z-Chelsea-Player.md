...
- **Timestamp:** 2025-03-28T12:04:30.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Ramires do Nascimento",
    "knownAs": "Ramires",
    ...
    "honours": ["FA Cup: 2011-12", "UEFA Champions League Runner-Up: 2011-12"],
    "individualAwards": [],
    "nationalTeamCaps": 35,
    "styleOfPlay": "An energetic and dynamic midfielder known for his relentless work rate, ability to contribute in both defense and attack, and exceptional stamina that made him a key asset in Chelsea's midfield during the 2012 season.",
    "legacyQuote": "A player whose engine never quits, always pushing the limits on both ends of the pitch.",
    "rivalries": [
      "Engaged in intense midfield battles in the Premier League, often clashing with top opponents in high-stakes matches."
    ],
    "mentorOf": [],
  ...
  "links": [
    {
      "url": "https://www.transfermarkt.com/ramires/profil/spieler/20814",
      "description": "Comprehensive career stats and transfer history for Ramires."
    },
    {
      "url": "https://www.chelseafc.com/en",
      "description": "Official Chelsea FC website with historical match reports and club news."
    }
  ]
}
```
