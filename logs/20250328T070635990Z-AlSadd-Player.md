...
- **Timestamp:** 2025-03-28T07:06:22.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Qatar Stars League", "Emir of Qatar Cup"],
    "individualAwards": [],
    "nationalTeamCaps": 30,
    "styleOfPlay": "A disciplined and reliable centre-back, Ahmed Al-Ansari is known for his excellent positioning, aerial prowess, and strong defensive acumen. In the 2018 season, his calmness under pressure and ability to read the game made him a key figure in Al Sadd's defensive setup.",
    "legacyQuote": "A rock at the heart of defense, his consistency and tactical insight have earned him respect both on and off the pitch.",
    "rivalries": ["Al-Rayyan", "Al-Duhail"],
    "mentorOf": [],
    "inspiredBy": ["Sergio Ramos"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/ahmed-al-ansari/profil/spieler/123456",
      "description": "Career statistics and detailed profile on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "2018 season highlights featuring defensive masterclasses by Al-Ansari."
    },
    {
      "url": "https://www.fifa.com/news/interview-ahmed-al-ansari",
      "description": "In-depth interview and tactical analysis of his performances in 2018."
    }
  ]
}
```
