...
- **Timestamp:** 2025-03-28T19:06:02.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Ronald Gómez",
    "knownAs": "Ronald Gómez",
    ...
    "honours": ["Costa Rican Primera División Champion (2004 Apertura)"],
    "individualAwards": ["Costa Rican Midfielder of the Year (2004)"],
    "nationalTeamCaps": 18,
    "styleOfPlay": "Ronald Gómez was known for his intelligent playmaking and precise distribution from the midfield. In 2004, his ability to control the tempo of the game, coupled with robust defensive work and creative forward passes, made him indispensable in Alajuelense’s system.",
    "legacyQuote": "A midfield maestro whose vision and consistency set the foundation for his team's success.",
    "rivalries": ["Key encounters against Saprissa during local derbies."],
    "mentorOf": [],
    "inspiredBy": ["Classic Costa Rican playmakers of the 90s"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/ronald-gomez/profil/spieler/000000",
      "description": "Transfermarkt profile providing a statistical overview of Ronald Gómez's career."
    },
    {
      "url": "https://www.national-football-teams.com/player/00000/Ronald_Gomez.html",
      "description": "National Football Teams profile detailing international appearances and stats."
    },
    {
      "url": "https://www.youtube.com/results?search_query=Ronald+G%C3%B3mez+Alajuelense+2004",
      "description": "YouTube search results featuring highlights from Ronald Gómez's performances in 2004."
    }
  ]
}
```
