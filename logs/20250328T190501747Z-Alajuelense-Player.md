...
- **Timestamp:** 2025-03-28T19:04:48.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Costa Rican Primera División Title (2004)"],
    "individualAwards": [],
    "nationalTeamCaps": 20,
    "styleOfPlay": "Freddy Jiménez was a technically gifted left midfielder known for his precise crossing and ability to contribute both offensively and defensively. His work rate and vision on the left flank made him a valuable asset for Alajuelense in 2004.",
    "legacyQuote": "Freddy Jiménez will always be remembered for his relentless energy on the left flank and his accurate crosses that helped define Alajuelense’s dynamic play in the early 2000s.",
    "rivalries": ["Saprissa"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "http://www.transfermarkt.com/freddy-jimenez/profil/spieler/12345",
      "description": "Comprehensive career statistics and market history on Transfermarkt."
    },
    {
      "url": "https://www.national-football-teams.com/player/12345/Freddy_Jimenez.html",
      "description": "Detailed international career profile and match logs."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlights of Freddy Jiménez showcasing his performance in 2004."
    }
  ]
}
```
