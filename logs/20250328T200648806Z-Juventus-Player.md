...
- **Timestamp:** 2025-03-28T20:06:11.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Serie A: 1996–97", "Coppa Italia: 1996–97", "Supercoppa Italiana: 1997"],
    "individualAwards": [],
    "nationalTeamCaps": 0,
    "styleOfPlay": "A disciplined and tactically astute left-back known for his defensive reliability, strong marking, and keen positional sense. While not the most flamboyant on the pitch, his consistency and work ethic ensured balance in Juventus' backline and provided steady support during transitions.",
    "legacyQuote": "Pessotto may not always grab the headlines, but his unwavering consistency and dedication from the left-back position set the standard for defensive professionalism.",
    "rivalries": ["AC Milan"],
    "mentorOf": [],
    "inspiredBy": ["Paolo Maldini"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/gianluca-pessotto/profil/spieler/XXXX",
      "description": "Transfermarkt profile for Gianluca Pessotto with career statistics and historical data."
    },
    {
      "url": "https://www.national-football-teams.com/player/XXXX/Gianluca_Pessotto.html",
      "description": "National Football Teams profile detailing his international and club career."
    },
    {
      "url": "https://www.youtube.com/watch?v=XXXX",
      "description": "Compilation video showcasing notable defensive highlights from his Juventus tenure."
    }
  ]
}
```
