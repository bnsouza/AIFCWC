...
- **Timestamp:** 2025-03-28T20:05:11.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Serie A Champion", "UEFA Champions League Runner-Up", "UEFA Super Cup Winner"],
    "individualAwards": ["French Midfielder of the Year"],
    "nationalTeamCaps": 103,
    "styleOfPlay": "A combative and tactically astute midfielder known for his exceptional leadership, intelligent distribution, and precise ball control. Deschamps excelled at balancing a defensive mindset with creative playmaking responsibilities.",
    "legacyQuote": "A midfield general whose intelligence and leadership redefined the role of a modern central midfielder.",
    "rivalries": [
      "Intense domestic clashes with Italian opponents",
      "Competitive encounters against top European midfield dynamos"
    ],
    "mentorOf": ["Emerging French midfield talents"],
    "inspiredBy": ["Midfield legends who combined tactical intelligence with leadership"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/didier-deschamps/profil/spieler/12345",
      "description": "Detailed career statistics and historical performance overview on Transfermarkt."
    },
    {
      "url": "https://www.fifa.com/worldcup/archive/",
      "description": "FIFA World Cup archive highlighting Deschamps' international contributions and performances."
    }
  ]
}
```
