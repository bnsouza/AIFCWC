...
- **Timestamp:** 2025-03-28T07:05:25.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Joffre Daylon Guerrón Valencia",
    "knownAs": "Joffre Guerrón",
    ...
    "honours": ["Qatar Stars League: 2018–19", "Emir of Qatar Cup: 2018"],
    "individualAwards": [],
    "nationalTeamCaps": 37,
    "styleOfPlay": "A dynamic and experienced right winger known for his explosive pace, close ball control, and ability to cut inside to create scoring opportunities. In 2018, his performances at Al Sadd showcased his technical flair and creativity on the ball while contributing defensively when needed.",
    "legacyQuote": "A player whose flair and experience brought excitement and vision to the game, leaving a mark in every match he played.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/joffre-guerron/profil/spieler/12880",
      "description": "Transfermarkt profile detailing Joffre Guerrón's career statistics and history."
    },
    {
      "url": "https://www.national-football-teams.com/player/12345/Joffre_Guerron.html",
      "description": "National Football Teams profile with international career information."
    },
    {
      "url": "https://www.youtube.com/watch?v=sampleAlSaddHighlight",
      "description": "Highlights of Joffre Guerrón's performances with Al Sadd in 2018."
    }
  ]
}
```
