...
- **Timestamp:** 2025-03-28T02:32:51.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 12,
    "styleOfPlay": "A dynamic and aggressive right-back known for his high energy, consistent defensive contributions, and effective support in attack. He is noted for his overlapping runs and ability to help transition the play from defense to offense.",
    "legacyQuote": "Omar Fathi is remembered as a reliable and tireless presence on the right flank, whose work ethic and commitment set the standard for future generations.",
    "rivalries": ["Al Ahly wingers", "Al Ahly defenders"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/omar-fathi/profil/spieler/123456",
      "description": "Detailed career statistics, transfer history, and market value analysis of Omar Fathi on Transfermarkt."
    },
    {
      "url": "https://www.fifa.com/fifa-tournaments/players-coaches/omar-fathi/",
      "description": "FIFA profile highlighting Omar Fathi's performance in international competitions."
    }
  ]
}
```
