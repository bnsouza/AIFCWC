...
- **Timestamp:** 2025-03-28T04:06:35.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Ligue 1: 2019–20", "Trophée des Champions: 2020"],
    "individualAwards": [],
    "nationalTeamCaps": 0,
    "styleOfPlay": "An energetic and dynamic right-back known for his explosive pace, robust defensive abilities, and effective overlapping runs that add width to PSG's attack. His quick transitions from defense to offense provide an attacking outlet, while his timing in tackles and positional awareness help cover defensive gaps.",
    "legacyQuote": "Despite his youth, Colin Dagba has quickly emerged as a rising talent at PSG, blending speed with tactical discipline to embody the modern full-back role.",
    "rivalries": [],
    "mentorOf": [],
  ...
  "links": [
    {
      "url": "https://www.transfermarkt.com/colin-dagba/profil/spieler/509447",
      "description": "Transfermarkt profile featuring detailed career statistics and market insights."
    },
    {
      "url": "https://www.youtube.com/watch?v=Zdjf3DRRpDw",
      "description": "YouTube highlights showcasing Colin Dagba's performances with PSG in 2020."
    }
  ]
}
```
