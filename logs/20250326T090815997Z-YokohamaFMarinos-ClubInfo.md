...
```
Provide the following details for the football club named Yokohama F. Marinos (Japan - AFC):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    ...
    "tiktok": "https://www.tiktok.com/@yokohamaf.marinos"
  },
  "colors": {
    "home": {
