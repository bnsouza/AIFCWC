...
- **Timestamp:** 2025-03-28T15:06:27.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Danilo Pereira da Silva",
    "knownAs": "Danilo",
    ...
    "honours": ["Paulista Championship"],
    "individualAwards": ["Team Player of the Year (2012)"],
    "nationalTeamCaps": 10,
    "styleOfPlay": "A dynamic and hardworking right midfielder known for his explosive runs down the flank and pinpoint crosses. Danilo combines good technical skills with tactical awareness, contributing both offensively and defensively.",
    "legacyQuote": "A team player whose consistency and precise deliveries on the right wing made him indispensable for Corinthians.",
    "rivalries": ["Notable on-field rivalries with opposing full-backs in intense state derbies"],
    "mentorOf": [],
    "inspiredBy": ["Robinho", "Rivaldo"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/danilo",
      "description": "Transfermarkt profile with detailed stats and career history."
    },
    {
      "url": "https://www.youtube.com/watch?v=danilo_highlights_2012",
      "description": "Highlights from Danilo's 2012 season at Corinthians."
    },
    {
      "url": "https://www.national-football-teams.com/player/xyz",
      "description": "Danilo's national team statistics and player details."
    }
  ]
}
```
