...
- **Timestamp:** 2025-03-28T15:05:33.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["FIFA Club World Cup: 2012"],
    "individualAwards": [],
    "nationalTeamCaps": 15,
    "styleOfPlay": "Alessandro is an energetic left-back known for his balance between defense and attack. His overlapping runs and accurate crossing provide excellent attacking support, while his strong marking and positioning keep the defense solid.",
    "legacyQuote": "A consistent performer whose reliability at the back earned him recognition in one of Brazil’s biggest clubs.",
    "rivalries": ["Flamengo"],
    "mentorOf": ["Junior", "Lucas"],
    "inspiredBy": ["Roberto Carlos"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/alessandro/profil/spieler/00000",
      "description": "Detailed career statistics and historical performance data for Alessandro."
    },
    {
      "url": "https://www.youtube.com/results?search_query=Alessandro+Corinthians+2012+highlights",
      "description": "Video highlights of Alessandro's standout performances during the 2012 season at Corinthians."
    }
  ]
}
```
