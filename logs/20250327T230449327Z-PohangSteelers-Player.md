...
- **Timestamp:** 2025-03-27T23:04:36.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["K-League Runner-up (2009 season)", "AFC Champions League Quarterfinalist"],
    "individualAwards": ["K-League Best XI Nominee"],
    "nationalTeamCaps": 12,
    "styleOfPlay": "A hardworking and disciplined defensive midfielder, Lee Gi-dong is known for his ability to break up opposition attacks and provide a solid base for his team. His strong tackling and keen sense of interception, combined with a reliable passing game, make him a vital cog in Pohang Steelers' midfield.",
    "legacyQuote": "Lee Gi-dong's commitment and tactical intelligence on the pitch have left an indelible mark on Pohang Steelers, embodying the spirit of resilience and teamwork.",
    "rivalries": ["Ulsan Hyundai (in fiercely contested local derbies)"],
    "mentorOf": [],
    "inspiredBy": ["Former South Korean midfielders known for their defensive prowess"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/lee-gi-dong/profil/spieler/12345",
      "description": "Transfermarkt profile with detailed statistics and career information"
    },
    {
      "url": "https://www.kleague.com",
      "description": "Official K-League website featuring historical articles and match reports from the 2009 season"
    }
  ]
}
```
