...
- **Timestamp:** 2025-03-28T03:17:48.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Stevie Chalmers",
    "knownAs": "Stevie Chalmers",
    "birthDate": "1935-01-26",
    ...
    "honours": ["European Cup: 1967", "Scottish League Title", "Scottish Cup"],
    "individualAwards": [],
    "nationalTeamCaps": 18,
    "styleOfPlay": "A classic poacher with an uncanny ability to find space in the box. Renowned for his instinctive movement and lethal finishing, he was happiest in front of goal, often rising to the occasion in big matches.",
    "legacyQuote": "He will forever be remembered for that unforgettable cup-final strike that cemented Celtic's place in football history.",
    "rivalries": ["Rangers"],
    "mentorOf": [],
    "inspiredBy": ["Great Scottish forwards of earlier eras"]
  },
  "links": [
    {
      "url": "https://www.celticfc.com",
      "description": "Official Celtic F.C. website containing historical archives about club legends including Stevie Chalmers."
    },
    {
      "url": "https://www.transfermarkt.com/stevie-chalmers/profil/spieler/12345",
      "description": "Statistical profile and career details on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=example-highlights",
      "description": "Video highlights of Stevie Chalmers' iconic goal in the 1967 European Cup final."
    }
  ]
}
```
