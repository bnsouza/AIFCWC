...
- **Timestamp:** 2025-03-28T19:04:32.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Juan Cayasso",
    "knownAs": "Juan Cayasso",
    ...
    "nationalTeamCaps": 20,
    "styleOfPlay": "A balanced central midfielder known for his ability to link defense and attack with precise passing, excellent vision, and strong teamwork. His game intelligence and work rate allowed him to control the midfield, making key contributions both offensively and defensively.",
    "legacyQuote": "A true engine in midfield, Juan Cayasso seamlessly connected the defense with the attack, embodying the spirit of determination and tactical intelligence.",
    "rivalries": ["Saprissa"],
    "mentorOf": [],
    "inspiredBy": ["Hernán Medford"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/juan-cayasso/profil/spieler/xxxxx",
      "description": "Transfermarkt profile for Juan Cayasso"
    },
    {
      "url": "https://www.national-football-teams.com/player/xxxxx/Juan_Cayasso.html",
      "description": "National Football Teams profile for Juan Cayasso"
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlights from the 2004 season with Alajuelense"
    }
  ]
}
```
