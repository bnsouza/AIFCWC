...
- **Timestamp:** 2025-03-28T16:08:48.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["League Cup: 1978–79"],
    "individualAwards": [],
    "nationalTeamCaps": 12,
    "styleOfPlay": "A creative midfielder known for his incisive through passes, vision, and ability to dictate the tempo of play. His technical finesse and tactical intelligence made him a pivotal playmaker at Nottingham Forest during a transformative period in the club's history.",
    "legacyQuote": "John Gamble was the heartbeat of the midfield, orchestrating play with vision and unparalleled creativity that lifted his team in critical moments.",
    "rivalries": ["Opposing creative midfielders"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/john-gamble/profil/spieler/12345",
      "description": "Career statistical profile on Transfermarkt"
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Highlight reel from the 1979 Nottingham Forest matches"
    }
  ]
}
```
