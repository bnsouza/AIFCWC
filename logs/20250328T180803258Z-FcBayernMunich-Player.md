...
- **Timestamp:** 2025-03-28T18:07:46.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Bundesliga Top Scorer (2012–13)"],
    "nationalTeamCaps": 78,
    "styleOfPlay": "A prolific striker known for his clinical finishing, strong aerial ability, and intelligent movement in the box. His physical presence combined with excellent positioning made him a constant threat in the penalty area.",
    "legacyQuote": "Mario Gómez is remembered as one of the most lethal forwards in modern Bundesliga history, with an instinct for goal that remains unparalleled.",
    "rivalries": ["Edin Džeko"],
    "mentorOf": [],
    "inspiredBy": ["Jürgen Klinsmann"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/mario-gomez/profil/spieler/6767",
      "description": "Detailed career statistics and historical performance data on Transfermarkt."
    },
    {
      "url": "https://www.fifa.com/worldcup/players/player/2102/",
      "description": "FIFA profile highlighting Mario Gómez's international career and tournament performances."
    }
  ]
}
```
