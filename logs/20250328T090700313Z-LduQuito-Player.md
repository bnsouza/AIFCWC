...
- **Timestamp:** 2025-03-28T09:06:45.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Diego Alexander Calderón",
    "knownAs": "Diego Calderón",
    ...
    "honours": ["Ecuadorian Serie A Champion (2008)"],
    "individualAwards": [],
    "nationalTeamCaps": 18,
    "styleOfPlay": "A deep-lying playmaker known for his precise passing, vision, and ability to control the tempo of the game. Calderón combined a high work rate with excellent ball control, often orchestrating LDU Quito’s attacking transitions and providing a steadying influence in midfield.",
    "legacyQuote": "Diego Calderón was the engine in midfield, orchestrating play with calm precision and setting the rhythm for his team.",
    "rivalries": ["Emelec", "Barcelona SC"],
    "mentorOf": [],
    "inspiredBy": ["Juan Cazares"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/diego-calderon/profil/spieler/12345",
      "description": "Transfermarkt profile for Diego Calderón detailing career statistics and transfer history."
    },
    {
      "url": "https://www.national-football-teams.com/player/12345/Diego_Calderon.html",
      "description": "National Football Teams profile offering a comprehensive overview of Calderón's international career."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Compilation of highlights featuring Diego Calderón's performances for LDU Quito in 2008."
    }
  ]
}
```
