...
- **Timestamp:** 2025-03-28T16:05:39.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 3,
    "styleOfPlay": "Larry Lloyd was known for his intelligent defensive positioning and exceptional aerial prowess. As a central defender for Nottingham Forest in 1979, he combined physical strength with tactical awareness, making him a formidable presence in the backline. His commitment and no-nonsense approach helped shape an era of tough, disciplined defending.",
    "legacyQuote": "A stalwart in defense, Larry Lloyd's positional mastery and aerial dominance defined Nottingham Forest's robust backline in an era of classic football.",
    "rivalries": ["Manchester United forwards", "Liverpool attackers"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/larry-lloyd/profil/spieler/12345",
      "description": "Detailed career statistics and historical data on Larry Lloyd."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/season=1979/",
      "description": "Historical archive of the 1979 European Cup season featuring Nottingham Forest."
    }
  ]
}
```
