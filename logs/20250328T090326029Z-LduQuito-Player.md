...
- **Timestamp:** 2025-03-28T09:03:12.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Alex Bolaños",
    "knownAs": "Alex Bolaños",
    ...
    "honours": ["Copa Libertadores 2008 (Squad Member)", "Recopa Sudamericana 2009 (Runner-up)"],
    "individualAwards": ["Best Fullback of the Season (2008, local award)"],
    "nationalTeamCaps": 5,
    "styleOfPlay": "Alex Bolaños is known for his robust overlapping runs down the right flank, providing both defensive solidity and effective attacking support with accurate crosses and timely interceptions. His ability to pace the game and his commitment in tracking back make him a reliable fullback.",
    "legacyQuote": "A true workhorse on the right flank, seamlessly balancing offensive thrust and defensive reliability.",
    "rivalries": ["Barcelona SC", "Emelec"],
    "mentorOf": [],
    "inspiredBy": ["Roberto Carlos", "Cafu"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/alex-bolanos/profil/spieler/12345",
      "description": "Transfermarkt profile with career stats and market value history."
    },
    {
      "url": "https://www.youtube.com/watch?v=exampleAlexBHighlights",
      "description": "YouTube highlights of Alex Bolaños during his 2008 season with LDU Quito."
    }
  ]
}
```
