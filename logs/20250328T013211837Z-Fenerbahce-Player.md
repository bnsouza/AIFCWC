...
- **Timestamp:** 2025-03-28T01:31:59.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Süper Lig Runner-Up (2012)"],
    "individualAwards": [],
    "nationalTeamCaps": 0,
    "styleOfPlay": "Oğuzhan Özyakışık is a disciplined central midfielder known for his intelligent distribution and reliable passing. In 2012, he showcased his ability to control the tempo of the game and contribute defensively while also providing creativity in attack.",
    "legacyQuote": "A hardworking midfielder with a keen eye for a perfectly timed pass, Oğuzhan embodies both determination and technical skill on the pitch.",
    "rivalries": ["Traditional Istanbul rivals in domestic encounters"],
    "mentorOf": [],
    "inspiredBy": ["Emre Belözoğlu"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/oguzhan-ozyakisik/profil/spieler/placeholder",
      "description": "Detailed career statistics and market value history on Transfermarkt."
    },
    {
      "url": "https://www.tff.org/Default.aspx?pageId=526&kisiID=placeholder",
      "description": "Turkish Football Federation profile detailing national team involvement and career data."
    },
    {
      "url": "https://www.youtube.com/results?search_query=Oguzhan+Ozyakisik+Fenerbahce+2012",
      "description": "YouTube search results for match highlights and performances from the 2012 season."
    }
  ]
}
```
