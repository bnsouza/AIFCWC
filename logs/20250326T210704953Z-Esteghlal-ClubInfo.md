## AI Generation Log: Esteghlal-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-26T21:07:02.000Z
...
```
Provide the following details for the football club named Esteghlal (Iran - AFC):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/esteghlal.fc",
    "tiktok": "https://www.tiktok.com/@esteghlal.fc"
  },
  "colors": {
    "home": {
