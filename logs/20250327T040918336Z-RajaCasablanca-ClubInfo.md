## AI Generation Log: RajaCasablanca-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-27T04:09:16.000Z
...
```
Provide the following details for the football club named Raja Casablanca (Morocco - CAF):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/rajacasablanca",
    "tiktok": "https://www.tiktok.com/@rajacasablanca"
  },
  "colors": {
    "home": {
      "bgColor": "rgb(0, 102, 0)",
