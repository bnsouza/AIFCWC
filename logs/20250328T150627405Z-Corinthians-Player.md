...
- **Timestamp:** 2025-03-28T15:06:12.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Copa Libertadores 2012", "Recopa Sudamericana 2012"],
    "individualAwards": [],
    "nationalTeamCaps": 10,
    "styleOfPlay": "A dynamic central midfielder known for his exceptional work rate, tactical discipline, and ability to link defense with attack seamlessly. In 2012 at Corinthians, he showcased his solid passing and vision, making him integral to the team's build-up play.",
    "legacyQuote": "A relentless engine in midfield with vision and determination, Paulinho set the stage for a new era of dynamic Brazilian midfielders.",
    "rivalries": ["São Paulo FC midfield units"],
    "mentorOf": [],
    "inspiredBy": ["Zico"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/paulinho/profil/spieler/12345",
      "description": "Paulinho's detailed career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=example123",
      "description": "Highlights from Paulinho's standout performances in 2012 with Corinthians."
    }
  ]
}
```
