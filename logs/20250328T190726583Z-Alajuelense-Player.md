...
- **Timestamp:** 2025-03-28T19:07:11.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Liga FPD Champion 2004", "Costa Rican Cup Winner 2004"],
    "individualAwards": [],
    "nationalTeamCaps": 25,
    "styleOfPlay": "A composed and tactically astute center-back, Marvin Mora is known for his excellent positional sense, strong aerial abilities, and disciplined defensive marking. His solid performances in the 2004 season helped solidify Alajuelense’s backline amidst strong domestic competition.",
    "legacyQuote": "A wall in defense, Marvin Mora's reading of the game set a benchmark for Costa Rican centre-backs.",
    "rivalries": ["Saprissa"],
    "mentorOf": ["Emerging defenders in Costa Rica"],
    "inspiredBy": ["Franco Baresi", "Paolo Maldini"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/marvin-mora/profil/spieler/12345",
      "description": "Transfermarkt profile of Marvin Mora with career statistics and market value history."
    },
    {
      "url": "https://www.concacaf.com/en/article/alajuelense-defensive-solidarity-marvin-mora",
      "description": "Article detailing Marvin Mora’s defensive contributions and season highlights in 2004."
    }
  ]
}
```
