...
- **Timestamp:** 2025-03-28T19:03:13.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Costa Rican Primera División Championship (2004)"],
    "individualAwards": [],
    "nationalTeamCaps": 12,
    "styleOfPlay": "A disciplined and tactically intelligent centre-back, Claudio Jara is known for his excellent positioning, robust marking, and aerial prowess. In 2004, his consistent defensive displays and ability to read the game helped solidify Alajuelense’s backline.",
    "legacyQuote": "A stalwart in defense, Claudio Jara's leadership and resilience on the pitch have left an indelible mark on Alajuelense's legacy.",
    "rivalries": ["Saprissa"],
    "mentorOf": [],
  ...
  "links": [
    {
      "url": "https://www.transfermarkt.com/claudio-jara/profile",
      "description": "Comprehensive career statistics and historical performance details for Claudio Jara."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Claudio_Jara",
      "description": "An overview of Claudio Jara's football career and his contributions to Costa Rican football."
    }
  ]
}
```
