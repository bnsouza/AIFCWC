...
- **Timestamp:** 2025-03-28T03:16:09.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Celtic Player of the Year 1967 (nomination)"],
    "nationalTeamCaps": 22,
    "styleOfPlay": "A robust and disciplined left back, John Clark was known for his reliable defending and effective overlapping runs. In 1967, his blend of stamina, tactical awareness, and commitment at both ends of the pitch made him a key contributor to Celtic's historic European success.",
    "legacyQuote": "A dependable and tireless presence on the left flank, John Clark's performances in 1967 remain a benchmark for Celtic defenders.",
    "rivalries": ["Rangers", "Aberdeen"],
    "mentorOf": ["Younger defenders at Celtic"],
    "inspiredBy": ["Classic Scottish defending"]
  },
  "links": [
    {
      "url": "https://www.celticfc.com",
      "description": "Official Celtic FC website with historical archives and match reports from the 1967 season."
    },
    {
      "url": "https://www.transfermarkt.com",
      "description": "Statistical profile and historical data of Celtic players including legacy figures from the 1960s."
    }
  ]
}
```
