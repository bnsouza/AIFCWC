...
- **Timestamp:** 2025-03-28T03:16:42.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 15,
    "styleOfPlay": "A dynamic central midfielder known for his exceptional vision and distribution, Hughes was instrumental in dictating the pace of the game. His calmness under pressure and sharp passing ability helped Celtic maintain fluid attacking transitions and solid defensive cover.",
    "legacyQuote": "John Hughes was the heartbeat of Celtic’s midfield in 1967, seamlessly blending creativity with work-rate, and leaving an indelible mark on European football history.",
    "rivalries": ["Rangers midfield rivals"],
    "mentorOf": [],
    "inspiredBy": ["Billy McNeill", "Jimmy Johnstone"]
  },
  "links": [
    {
      "url": "https://www.celticfc.com/history/celtic-european-cup-1967",
      "description": "Overview of Celtic's historic 1967 European Cup victory."
    },
    {
      "url": "https://www.scottishfootballhistorian.com/articles/celtics-midfield-maestros",
      "description": "In-depth article on the midfield tactics and key players of Celtic in the 1960s."
    }
  ]
}
```
