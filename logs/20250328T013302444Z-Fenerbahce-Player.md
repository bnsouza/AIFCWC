...
- **Timestamp:** 2025-03-28T01:32:45.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 15,
    "styleOfPlay": "A classic striker known for his intelligent movement and goal-scoring instincts, Semih Şentürk excelled at finding space in the box. His strong physical presence, combined with precise finishing and aerial ability, made him a constant threat during set-pieces and open play. His positional sense ensured that he was frequently in the right spot at the right time, a trait that earned him a reputation as an effective goal poacher.",
    "legacyQuote": "Semih Şentürk left an indelible mark as a player who consistently capitalized on defensive lapses, earning him a reputation as a relentless goal poacher.",
    "rivalries": ["Istanbul Derby rivals"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/semih-senturk/profil/spieler/11700",
      "description": "Detailed career statistics and historical performance of Semih Şentürk on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=example_highlights",
      "description": "Compilation of Semih Şentürk's key goals and highlights during his time at Fenerbahçe."
    }
  ]
}
```
