...
- **Timestamp:** 2025-03-28T04:05:34.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Ligue 1 Champion", "Coupe de la Ligue Winner", "French Super Cup Winner"],
    "individualAwards": ["Ligue 1 Young Player of the Year", "UNFP Player of the Month"],
    "nationalTeamCaps": 30,
    "styleOfPlay": "Mbappé is renowned for his explosive pace, clinical finishing, and mesmerizing dribbling ability. His off-the-ball movement and quick decision-making make him a constant threat on the right wing, capable of turning defense into attack in moments.",
    "legacyQuote": "A once-in-a-generation talent redefining the modern forward role.",
    "rivalries": ["Top European defenders", "Opposing clubs with a history of high-paced counterattacks"],
    "mentorOf": [],
    "inspiredBy": ["Cristiano Ronaldo", "Lionel Messi", "Thierry Henry"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/kylian-mbappe/profil/spieler/342229",
      "description": "Transfermarkt profile for Kylian Mbappé showcasing his stats and career trajectory."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/teams/players/250087944--kylian-mbappe/",
      "description": "UEFA Champions League profile highlighting Mbappé's performances in European competitions."
    },
    {
      "url": "https://www.youtube.com/watch?v=2ScOqkFeO7I",
      "description": "Highlight reel of Mbappé's explosive speed, dribbling, and goals from the 2020 season."
    }
  ]
}
```
