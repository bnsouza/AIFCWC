...
- **Timestamp:** 2025-03-28T07:03:55.000Z
...
-  Player Name: Mohammed Abdulqadir
-  Club: Al Sadd
-  Year: 2018
-  Position: CB
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Al Sadd Team of the Season (2018)"],
    "nationalTeamCaps": 25,
    "styleOfPlay": "A composed and tactically astute centre back, Mohammed Abdulqadir is known for his exceptional aerial ability, disciplined marking, and timely interceptions. In 2018, his blend of physical prowess and smart positioning helped stabilize Al Sadd's defense, allowing the team to build from the back effectively.",
    "legacyQuote": "A rock at the heart of the defence, Mohammed Abdulqadir set the standard for modern centre-back play with his consistent and intelligent performances.",
    "rivalries": ["Top opposition forwards in the Qatar Stars League"],
    "mentorOf": ["Emerging young defenders at Al Sadd"],
    "inspiredBy": ["Sergio Ramos", "Carles Puyol"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/mohammed-abdulqadir/profil/spieler/123456",
      "description": "Detailed career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/watch?v=example",
      "description": "Compilation of Mohammed Abdulqadir's best defensive moments in 2018."
    }
  ]
}
```
