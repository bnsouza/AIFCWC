...
- **Timestamp:** 2025-03-28T16:08:07.000Z
...
```json
{
  ...
  "attributes": {
    ...
    "specialSkill": "GoldenGlove"
  },
  "history": {
    "fullName": "John Robert Middleton",
    "knownAs": "John Middleton",
    ...
    "honours": ["European Cup 1979", "FA Cup Runner-up 1979"],
    "individualAwards": ["Nottingham Forest Player of the Year 1979"],
    "nationalTeamCaps": 5,
    "styleOfPlay": "A solid shot-stopper known for his quick reflexes and excellent command of the penalty area, Middleton stayed composed under pressure and excelled in one-on-one situations. His ability to distribute the ball effectively also helped initiate counterattacks.",
    "legacyQuote": "A guardian of the Forest post, Middleton's performances in 1979 laid the foundation for one of the club's most glorious eras.",
    "rivalries": ["West Bromwich Albion's striking force"],
    "mentorOf": [],
    "inspiredBy": ["Gordon Banks"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/john-middleton/profil/spieler/123456",
      "description": "Transfermarkt profile with comprehensive career statistics and historical data."
    },
    {
      "url": "https://www.nottinghamforest.co.uk/club/history",
      "description": "Official Nottingham Forest history page detailing the club's iconic 1979 European Cup-winning season."
    }
  ]
}
```
