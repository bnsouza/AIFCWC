...
- **Timestamp:** 2025-03-28T09:04:59.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Copa Libertadores 2008"],
    "individualAwards": [],
    "nationalTeamCaps": 5,
    "styleOfPlay": "An electrifying right winger known for his swift dribbling, technical finesse, and creativity on the ball. Guerrón's ability to cut inside and deliver key passes makes him a significant attacking threat. His pace and agility allowed him to excel on counter-attacks and provide width in LDU Quito's dynamic play.",
    "legacyQuote": "A spark on the right flank, his pace and flair changed the dynamics of the game.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Brazilian wingers of flair and speed"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/joffre-guerron/profil/spieler/56642",
      "description": "Transfermarkt profile for detailed career statistics and history."
    },
    {
      "url": "https://www.national-football-teams.com/player/XXXX/Joffre_Guerron.html",
      "description": "National Football Teams profile providing match data and international appearances."
    },
    {
      "url": "https://www.youtube.com/watch?v=dummy",
      "description": "Compilation of Joffre Guerrón's highlights during his time at LDU Quito in 2008."
    }
  ]
}
```
