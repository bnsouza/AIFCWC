## AI Generation Log: Millonarios-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-27T22:01:37.000Z
...
```
Provide the following details for the football club named Millonarios (Colombia - CONMEBOL):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/millosfcoficial",
    "tiktok": "https://www.tiktok.com/@millosfcoficial"
  },
  "colors": {
    "home": {
