...
- **Timestamp:** 2025-03-28T12:03:13.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["UEFA Champions League: 2011–12", "FA Cup: 2011–12", "Premier League: 2014–15"],
    "individualAwards": ["Chelsea Player of the Year (Nominee)"],
    "nationalTeamCaps": 61,
    "styleOfPlay": "A commanding presence in defense, Cahill is known for his exceptional positioning, aerial prowess, and leadership. His calmness under pressure and ability to read the game make him a linchpin in Chelsea’s backline.",
    "legacyQuote": "A rock at the back, Gary Cahill’s consistency and determination set the standard for modern center-backs.",
    "rivalries": ["Manchester United", "Arsenal"],
    "mentorOf": [],
    "inspiredBy": ["Sol Campbell", "John Terry"]
  },
  "links": [
    {
      "url": "https://www.chelseafc.com/en/teams/first-team/gary-cahill",
      "description": "Official Chelsea profile for Gary Cahill."
    },
    {
      "url": "https://www.transfermarkt.com/gary-cahill/profil/spieler/1494",
      "description": "Gary Cahill career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.premierleague.com/players/2663/Gary-Cahill/overview",
      "description": "Premier League overview of Gary Cahill's career."
    }
  ]
}
```
