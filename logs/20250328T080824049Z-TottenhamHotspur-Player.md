...
- **Timestamp:** 2025-03-28T08:08:02.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": [],
    "nationalTeamCaps": 8,
    "styleOfPlay": "An agile winger known for his pace, creativity, and ability to take on defenders. Townsend is adept at cutting inside from the right flank and delivering dangerous crosses, making him a constant threat in the final third.",
    "legacyQuote": "A player who brought unpredictability and flair to the right wing, leaving a lasting impression on Tottenham's attacking style.",
    "rivalries": ["Arsenal"],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/andros-townsend/profil/spieler/12736",
      "description": "Transfermarkt profile of Andros Townsend."
    },
    {
      "url": "https://www.national-football-teams.com/player/33324/Andros_Townsend.html",
      "description": "National Football Teams profile of Andros Townsend."
    }
  ]
}
```
