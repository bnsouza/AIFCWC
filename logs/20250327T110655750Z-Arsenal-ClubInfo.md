## AI Generation Log: Arsenal-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-27T11:06:51.000Z
...
```
Provide the following details for the football club named Arsenal (England - UEFA):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    ...
    "tiktok": "https://www.tiktok.com/@arsenal"
  },
  "colors": {
    "home": {
      "bgColor": "rgb(239,1,7)",
