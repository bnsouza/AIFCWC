...
- **Timestamp:** 2025-03-28T03:18:52.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Scottish League Champion (1967)", "Scottish Cup Winner (1967)"],
    "individualAwards": [],
    "nationalTeamCaps": 15,
    "styleOfPlay": "A dynamic central midfielder known for his precise passing, excellent vision, and ability to drive the tempo of the game through a blend of technical skill and tactical intelligence. In 1967, he was pivotal in orchestrating Celtic's midfield, blending creativity with disciplined play.",
    "legacyQuote": "Ian Reid was the heartbeat of Celtic's midfield in the late 1960s, orchestrating play with composure and creativity.",
    "rivalries": ["Rangers midfield contemporaries"],
    "mentorOf": [],
    "inspiredBy": ["Billy McNeill", "John Collins"]
  },
  "links": [
    {
    ...
    },
    {
      ...
      "description": "Official Celtic FC website with historical insights and archives."
    }
  ]
}
```
