...
- **Timestamp:** 2025-03-28T19:04:16.000Z
...
```json
{
  ...
  "history": {
    ...
    "individualAwards": ["Best Midfielder 2004"],
    "nationalTeamCaps": 18,
    "styleOfPlay": "An intelligent playmaker, Mauricio Solís orchestrated the midfield with sharp vision, precise distribution, and steady composure. His ability to control the tempo of the match made him a key component in Alajuelense's strategies during the 2004 season.",
    "legacyQuote": "A midfield maestro whose vision transformed matches at Alajuelense.",
    "rivalries": ["Saprissa"],
    "mentorOf": ["Andrés González"],
    "inspiredBy": ["Walter Centeno"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/mauricio-solis/profil/spieler/000000",
      "description": "Detailed career statistics and transfer history on Transfermarkt."
    },
    {
      "url": "https://www.youtube.com/results?search_query=Mauricio+Sol%C3%ADs+Alajuelense+2004",
      "description": "Video highlights from Mauricio Solís' 2004 season with Alajuelense."
    }
  ]
}
```
