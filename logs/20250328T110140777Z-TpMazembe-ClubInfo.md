## AI Generation Log: TpMazembe-ClubInfo

- **Model:** gpt-4o-2024-08-06
- **Timestamp:** 2025-03-28T11:01:38.000Z
...
```
Provide the following details for the football club named TP Mazembe (Democratic Republic of the Congo - CAF):
- Foundation date
- City
- Full name
- Short name
...
```json
{
  ...
  "socialMedia": {
    "instagram": "https://www.instagram.com/tpmazembe/",
    "tiktok": "https://www.tiktok.com/@tpmazembe"
  },
  "colors": {
    "home": {
      "bgColor": "rgb(0, 0, 0)",
