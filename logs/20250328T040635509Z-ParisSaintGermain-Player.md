...
- **Timestamp:** 2025-03-28T04:06:22.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Ligue 1 Champion (2020)", "Coupe de France Winner (2020)"],
    "individualAwards": [],
    "nationalTeamCaps": 10,
    "styleOfPlay": "A modern attacking left-back known for his overlapping runs, defensive diligence, and ability to contribute both offensively and defensively. Kurzawa combines pace with technical excellence along the flank, providing width and support in attacking transitions while maintaining a solid defensive line.",
    "legacyQuote": "A perfect blend of pace and precision on the flank, embodying the evolving role of full-backs in modern football.",
    "rivalries": [
      "Rivalries typically emerge against opposing wingers and full-backs in high-stakes Ligue 1 encounters"
    ],
    "mentorOf": [],
    "inspiredBy": ["Philipp Lahm"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/layvin-kurzawa/profil/spieler/132961",
      "description": "Detailed statistical profile and career information on Transfermarkt."
    },
    {
      "url": "https://en.psg.fr/teams/first-team/squad/layvin-kurzawa",
      "description": "Official profile at Paris Saint-Germain's website."
    }
  ]
}
```
