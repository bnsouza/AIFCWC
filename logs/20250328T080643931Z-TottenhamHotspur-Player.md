...
- **Timestamp:** 2025-03-28T08:06:17.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Ligue 1: 2013–14", "Ligue 1: 2014–15", "Coupe de la Ligue: 2013–14"],
    "individualAwards": ["Tottenham Hotspur Player of the Month"],
    "nationalTeamCaps": 30,
    "styleOfPlay": "An electrifying right winger known for his blistering pace, exceptional dribbling, and the ability to cut in from the flank to create or score goals. His energetic runs and decisive bursts often disrupt defenses and provide Tottenham with a dynamic attacking option.",
    "legacyQuote": "Lucas Moura's relentless energy and flair on the wing not only added pace to Tottenham's attack but also inspired his teammates with moments of individual brilliance.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": ["Neymar", "Ronaldinho"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/lucas-moura/profil/spieler/185773",
      "description": "Transfermarkt profile for Lucas Moura, detailing his career statistics and transfers."
    },
    {
      "url": "https://www.tottenhamhotspur.com/teams/first-team/players/lucas-moura/",
      "description": "Official Tottenham Hotspur profile for Lucas Moura."
    },
    {
      "url": "https://www.youtube.com/watch?v=OP7uF0p4f5Y",
      "description": "Compilation of Lucas Moura's highlights from the 2019 season."
    }
  ]
}
```
