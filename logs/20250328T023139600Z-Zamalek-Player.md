...
- **Timestamp:** 2025-03-28T02:31:19.000Z
...
-  Player Name: Mohamed Abdel-Shafy
-  Club: Zamalek
-  Year: 2016
-  Position: CM
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Egyptian Premier League: 2014-15", "Egypt Cup: 2015-16"],
    "individualAwards": [],
    "nationalTeamCaps": 45,
    "styleOfPlay": "A deep-lying playmaker known for his vision, precise passing, and ability to dictate the tempo of the game. His intelligent reading of the game allowed Zamalek to effectively transition from defense to attack.",
    "legacyQuote": "A midfielder who exemplified balance and intelligence, turning defense into attack with a single pass.",
    "rivalries": ["Al Ahly midfield battles"],
    "mentorOf": ["Emerging talents at Zamalek"],
    "inspiredBy": ["Egyptian midfield legends"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/mohamed-abdel-shafy/profil/spieler/123456",
      "description": "Transfermarkt profile showcasing career stats and history."
    },
    {
      "url": "https://www.espn.com/soccer/player/_/id/256789",
      "description": "ESPN profile with highlights and performance analysis."
    }
  ]
}
```
