...
- **Timestamp:** 2025-03-28T20:04:32.000Z
...
```json
{
  ...
  "history": {
    "fullName": "Angelo Di Livio",
    "knownAs": "Di Livio",
    "birthDate": "1966-07-10",
    "nationality": "Italian",
    "preferredFoot": "right",
    "height": 178,
    "weight": 75,
    ...
    "honours": ["Serie A Champion", "Coppa Italia Winner"],
    "individualAwards": [],
    "nationalTeamCaps": 22,
    "styleOfPlay": "A versatile, hardworking right-back known for his tireless running, tactical intelligence, and consistent performances on both ends of the pitch. Di Livio provided reliable defensive support while contributing effective crosses and linking play with midfield.",
    "legacyQuote": "A true team player whose dedication on the pitch exemplified the spirit of Juventus, inspiring teammates with his commitment and work ethic.",
    "rivalries": [],
    "mentorOf": [],
    "inspiredBy": []
  },
  "links": [
    {
      "url": "https://en.wikipedia.org/wiki/Angelo_Di_Livio",
      "description": "Detailed Wikipedia profile covering Di Livio's career and achievements."
    },
    {
      "url": "https://www.transfermarkt.com/angelo-di-livio/profil/spieler/36308",
      "description": "Career statistics and historical data for Angelo Di Livio on Transfermarkt."
    },
    {
      "url": "https://www.uefa.com/uefachampionsleague/clubs/50098--juventus/",
      "description": "Juventus's historical performance in UEFA competitions during Di Livio's era."
    }
  ]
}
```
