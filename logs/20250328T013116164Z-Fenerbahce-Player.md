...
- **Timestamp:** 2025-03-28T01:31:01.000Z
...
```json
{
  ...
  "history": {
    ...
    "honours": ["Turkish Super League Champion (2010–11)", "Turkish Cup Runner-up (2012)"],
    "individualAwards": [],
    "nationalTeamCaps": 35,
    "styleOfPlay": "A composed and physically dominant centre-back, Servet Çetin is known for his intelligent reading of the game, strong marking, and effective aerial presence. In 2012, his performances for Fenerbahçe highlighted his consistency and reliability in defense, often being the deciding factor in crucial matches.",
    "legacyQuote": "A rock in defense, Servet Çetin's commitment and tactical awareness in 2012 epitomized the resilience and spirit of Fenerbahçe.",
    "rivalries": [
      "Notable on-field rivalries with top Turkish forwards and centre-backs from competing Istanbul clubs"
    ],
    "mentorOf": [],
    "inspiredBy": ["Bülent Korkmaz"]
  },
  "links": [
    {
      "url": "https://www.transfermarkt.com/servet-cetin/profil/spieler/1234",
      "description": "Comprehensive career statistics and history on Transfermarkt."
    },
    {
      "url": "https://en.wikipedia.org/wiki/Servet_%C3%87etin",
      "description": "Wikipedia profile detailing Servet Çetin's career and achievements."
    },
    {
      "url": "https://www.fenerbahce.org/en/fb-legends",
      "description": "Fenerbahçe official profile and legacy information on club legends."
    }
  ]
}
```
